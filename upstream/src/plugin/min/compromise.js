/**
 * @license
 * Based on 'compromise' by Spencer Kelly (@spencermountain)
...
!function(e, t) {
    ...
    const t = {
        compute: function(e) {
            ...
            )) : "function" == typeof e ? e(this) : console.warn("no compute:", e),
            this
        }
    };
    var n = {
        ...
        map: function(e, t) {
            const n = this.fullPointer.map(( (t, n) => {
                const r = this.update([t])
                  , o = e(r, n);
                return void 0 === o ? this.none() : o
            }
            ));
            if (0 === n.length)
        ...
        find: function(e) {
            const t = this.fullPointer.find(( (t, n) => {
                const r = this.update([t]);
                return e(r, n)
            }
            ));
        ...
        random: function(e=1) {
            ...
            return n + e > this.length && (n = this.length - e,
            n = n < 0 ? 0 : n),
            t = t.slice(n, n + e),
            this.update(t)
        }
    ...
    const r = {
        ...
        eq: function(e) {
            let t = this.pointer;
            return t || (t = this.docs.map(( (e, t) => [t]))),
        ...
        fullSentences: function() {
            const e = this.fullPointer.map((e => [e[0]]));
        ...
        isDoc: function(e) {
            if (!e || !e.isView)
                return !1;
            const t = this.fullPointer
              , n = e.fullPointer;
            return !t.length !== n.length && t.every(( (e, t) => !!n[t] && (e[0] === n[t][0] && e[1] === n[t][1] && e[2] === n[t][2])))
        },
        wordCount: function() {
            return this.docs.reduce(( (e, t) => (e += t.filter((e => "" !== e.text)).length,
            e)), 0)
        },
        isFull: function() {
            ...
            let t = 0
              , n = 0;
            return this.document.forEach((e => t += e.length)),
    ...
    class View {
        constructor(t, n, r={}) {
            [["document", t], ["world", e], ["_groups", r], ["_cache", null], ["viewType", "View"]].forEach((e => {
        ...
        get docs() {
            let t = this.document;
            return this.ptrs && (t = e.methods.one.getDoc(this.ptrs, this.document)),
            t
        }
        get pointer() {
            return this.ptrs
        ...
        get fullPointer() {
            const {docs: e, ptrs: t, document: n} = this
              , r = t || e.map(( (e, t) => [t]));
            return r.map((e => {
                let[t,r,o,a,i] = e;
                return r = r || 0,
                o = o || (n[t] || []).length,
                n[t] && n[t][r] && (a = a || n[t][r].id,
                n[t][o - 1] && (i = i || n[t][o - 1].id)),
                [t, r, o, a, i]
            }
            ))
        }
        update(e) {
            const t = new View(this.document,e);
            if (this._cache && e && e.length > 0) {
                const n = [];
                e.forEach(( (e, t) => {
                    const [r,o,a] = e;
                    (1 === e.length || 0 === o && this.document[r].length === a) && (n[t] = this._cache[r])
                }
                )),
                n.length > 0 && (t._cache = n)
            }
            return t.world = this.world,
            t
        }
        toView(e) {
        ...
        fromText(e) {
            const {methods: t} = this
              , n = t.one.tokenize.fromString(e, this.world)
              , r = new View(n);
            return r.world = this.world,
        ...
        clone() {
            ...
            e = e.map((e => e.map((e => ((e = Object.assign({}, e)).tags = new Set(e.tags),
            e)))));
            const t = this.update(this.pointer);
            return t.document = e,
            t._cache = this._cache,
            t
        }
    }
    ...
    function i(e, t) {
        if (a(t))
            for (const n in t)
                a(t[n]) ? (e[n] || Object.assign(e, {
                    [n]: {}
                }),
                i(e[n], t[n])) : Object.assign(e, {
                    [n]: t[n]
                });
        return e
    }
    const s = function(e, t, n, r) {
        ...
        "[object Array]" === Object.prototype.toString.call(o))
            return void e.forEach((e => s(e, t, n, r)));
        var o;
        const {methods: a, model: l, compute: u, hooks: c} = t;
        ...
        e.model && i(l, e.model),
        e.irregulars && function(e, t) {
            const n = e.two.models || {};
            Object.keys(t).forEach((e => {
                t[e].pastTense && (n.toPast && (n.toPast.ex[e] = t[e].pastTense),
                n.fromPast && (n.fromPast.ex[t[e].pastTense] = e)),
                t[e].presentTense && (n.toPresent && (n.toPresent.ex[e] = t[e].presentTense),
                n.fromPresent && (n.fromPresent.ex[t[e].presentTense] = e)),
                t[e].gerund && (n.toGerund && (n.toGerund.ex[e] = t[e].gerund),
                n.fromGerund && (n.fromGerund.ex[t[e].gerund] = e)),
                t[e].comparative && (n.toComparative && (n.toComparative.ex[e] = t[e].comparative),
                n.fromComparative && (n.fromComparative.ex[t[e].comparative] = e)),
                t[e].superlative && (n.toSuperlative && (n.toSuperlative.ex[e] = t[e].superlative),
                n.fromSuperlative && (n.fromSuperlative.ex[t[e].superlative] = e))
            }
            ))
        }(l, e.irregulars),
        e.compute && Object.assign(u, e.compute),
        c && (t.hooks = c.concat(e.hooks || [])),
        e.api && e.api(n),
      ...
      , u = function(e, t, n) {
        ...
        !e)
            return o;
        if ("string" == typeof e) {
            return new t(r.one.tokenize.fromString(e, n))
        }
        if (a = e,
        "[object Object]" === Object.prototype.toString.call(a) && e.isView)
            return new t(e.document,e.ptrs);
        var a;
        if (l(e)) {
            if (l(e[0])) {
                const n = e.map((e => e.map((e => ({
                    text: e,
                    normal: e,
                    pre: "",
                    post: " ",
            ...
            const n = e.map((e => e.terms.map((e => (l(e.tags) && (e.tags = new Set(e.tags)),
            e)))));
            return new t(n)
        }
        return o
      ...
      , h = function(e, t) {
        t && h.addWords(t);
        const n = u(e, View, c);
        return e && n.compute(c.hooks),
        n
    };
    Object.defineProperty(h, "_world", {
        value: c,
        writable: !0
    }),
    h.tokenize = function(e, t) {
        ...
        t && h.addWords(t);
        const r = u(e, View, c);
        return n.contractions && r.compute(["alias", "normal", "machine", "contractions"]),
        r
    }
    ,
    h.plugin = function(e) {
        return s(e, this._world, View, this),
        this
    }
    ,
    h.extend = h.plugin,
    ...
    h.verbose = function(e) {
        ...
        return t.DEBUG_TAGS = "tagger" === e || !0 === e || "",
    ...
    const m = {
        cache: function() {
            return this._cache = this.methods.one.cacheDoc(this.document),
            this
        },
        uncache: function() {
    ...
    const f = e => /^\p{Lu}[\p{Ll}'’]/u.test(e) || /^\p{Lu}$/u.test(e)
      ...
      , y = (e, t, n) => {
        ...
        const a = o.post;
        if (r.test(a)) {
            const e = a.match(r).join("")
              , t = n[n.length - 1];
            t.post = e + t.post,
            o.post = o.post.replace(r, "")
        }
    }
      , w = function(e, t, n, r) {
        const [o,a,i] = t;
        0 === a || i === r[o].length ? v(n) : (v(n),
        v([e[t[1]]])),
        function(e, t, n) {
            const r = e[t];
            if (0 !== t || !f(r.text))
            ...
            const o = e[t];
            o.tags.has("ProperNoun") || o.tags.has("Acronym") || f(o.text) && o.text.length > 1 && (o.text = (a = o.text,
            a.replace(/^\p{Lu}/u, (e => e.toLowerCase()))));
            var a
        }(e, a, n),
        b(e, a, n)
    };
    let k = 0;
    const P = e => (e = e.length < 3 ? "0" + e : e).length < 3 ? "0" + e : e
      , A = function(e) {
        let[t,n] = e.index || [0, 0];
        k += 1,
        k = k > 46655 ? 0 : k,
        ...
        o = o.length < 2 ? "0" + o : o,
        r += o;
        return r += parseInt(36 * Math.random(), 10).toString(36),
      ...
      , j = function(e, t, n) {
        ...
        t.uncache();
        const a = t.fullPointer
          , i = t.fullPointer;
        t.forEach(( (s, l) => {
            const u = s.fullPointer[0]
              , [c] = u
              , h = r[c];
            let d = function(e, t) {
                const {methods: n} = t;
                return "string" == typeof e ? n.one.tokenize.fromString(e, t)[0] : "object" == typeof e && e.isView ? e.clone().docs[0] || [] : N(e) ? N(e[0]) ? e[0] : e : []
            }(e, o);
            0 !== d.length && (d = function(e) {
                return e.map((e => (e.id = A(e),
                e)))
            }(d),
            n ? (C(t.update([u]).firstTerm()),
            w(h, u, d, r)) : (C(t.update([u]).lastTerm()),
            function(e, t, n, r) {
                const [o,,a] = t
                  , i = (r[o] || []).length;
                a < i ? (y(e, a, n),
    ...
    T.replaceWith = function(e, t={}) {
        ...
        if (!o)
            return r;
        const a = t.possessives && o[o.length - 1].tags.has("Possessive")
          , i = t.case && (s = o[0].text,
        ...
        const l = this.update(n);
        n = n.map((e => e.slice(0, 3)));
        const u = (l.docs[0] || []).map((e => Array.from(e.tags)))
          , c = l.docs[0][0].pre
          , h = l.docs[0][l.docs[0].length - 1].post;
        if ("string" == typeof e && (e = this.fromText(e).compute("id")),
        r.insertAfter(e),
        l.has("@hasContraction") && r.contractions) {
        ...
        a) {
            const e = r.docs[0]
              , t = e[e.length - 1];
            t.tags.has("Possessive") || (t.text += "'s",
            t.normal += "'s",
            t.tags.add("Possessive"))
        }
        if (c && r.docs[0] && (r.docs[0][0].pre = c),
        h && r.docs[0]) {
            const e = r.docs[0][r.docs[0].length - 1];
            e.post.trim() || (e.post = h)
        }
        const d = r.toView(n).compute(["index", "freeze", "lexicon"]);
        if (d.world.compute.preTagger && d.compute("preTagger"),
        d.compute("unfreeze"),
        t.tags && d.terms().forEach(( (e, t) => {
            e.tagSafe(u[t])
        }
        )),
        !d.docs[0] || !d.docs[0][0])
    ...
    T.replace = function(e, t, n) {
        ...
        return r.found ? (this.soften(),
        r.replaceWith(t, n)) : this
    }
    ;
    const E = {
        remove: function(e) {
            ...
            let a = n.fullPointer;
            const i = r.fullPointer.reverse()
              , s = function(e, t) {
                t.forEach((t => {
                    const [n,r,o] = t
                      , a = o - r;
                    e[n] && (o === e[n].length && o > 1 && function(e, t) {
                        const n = e.length - 1
                          , r = e[n]
                          , o = e[n - t];
                        o && r && (o.post += r.post,
                        o.post = o.post.replace(/ +([.?!,;:])/, "$1"),
                        o.post = o.post.replace(/[,;:]+([.?!])/, "$1"))
                    }(e[n], a),
                    e[n].splice(r, a))
                }
            ...
            if (a = function(e, t) {
                ...
                e = (e = e.filter((e => e[2] - e[1] > 0))).map((e => (e[3] = null,
                e[4] = null,
                e)))
            }(a, t(i)),
            n.ptrs = a,
    ...
    const G = {
        ...
        post: function(e, t) {
            if (void 0 === e) {
                const e = this.docs[this.docs.length - 1];
    ...
    G.deHyphenate = G.dehyphenate,
    G.toQuotation = G.toQuotations;
    var O = {
        alpha: (e, t) => e.normal < t.normal ? -1 : e.normal > t.normal ? 1 : 0,
        length: (e, t) => {
            const n = e.normal.trim().length
    ...
    const F = new Set(["index", "sequence", "seq", "sequential", "chron", "chronological"])
    ...
    var B = {
        ...
        sort: function(e) {
            ...
            "function" == typeof e)
                return function(e, t) {
                    let n = e.fullPointer;
                    return n = n.sort(( (n, r) => (n = e.update([n]),
                    r = e.update([r]),
                    t(n, r)))),
                    e.ptrs = n,
                    e
            ...
            return F.has(e) && (e = "sequential"),
            z.has(e) && (e = "alpha"),
            V.has(e) ? (o = O.byFreq(o),
            this.update(o.map((e => e.pointer)))) : "function" == typeof O[e] ? (o = o.sort(O[e]),
            this.update(o.map((e => e.pointer)))) : this
        }
    };
            ...
            if ("object" == typeof e && e.isView)
                return function(e, t) {
                    if (e.document === t.document) {
                        const n = e.fullPointer.concat(t.fullPointer);
    ...
    var M = {
        ...
        soften: function() {
            let e = this.ptrs;
            return !e || e.length < 1 || (e = e.map((e => e.slice(0, 3))),
            this.ptrs = e),
            this
        }
    };
    const L = Object.assign({}, {
        ...
        toCamelCase: function() {
            return this.docs.forEach((e => {
                e.forEach(( (t, n) => {
                    0 !== n && (t.text = t.text.replace(/^ *[a-z\u00C0-\u00FF]/, (e => e.toUpperCase()))),
                    n !== e.length - 1 && (t.post = "")
                }
                ))
            }
    ...
    const U = function(e, t, n) {
        const [r,o] = t;
        n && 0 !== n.length && (n = n.map(( (e, t) => (e.implicit = e.text,
        e.machine = e.text,
        e.pre = "",
        e.post = "",
        e.text = "",
        ...
        e.index = [r, o + t],
        e))),
        n[0] && (n[0].pre = e[r][o].pre,
        n[n.length - 1].post = e[r][o].post,
        n[0].text = e[r][o].text,
        n[0].normal = e[r][o].normal),
        e[r].splice(o, 1, ...n))
    }
      , R = /'/
    ...
    var te = (e, t) => ["je", e[t].normal.split(X)[1]]
      , ne = (e, t) => {
        const n = e[t].normal.split(X)[1];
        return n && n.endsWith("e") ? ["la", n] : ["le", n]
    }
      , re = (e, t) => {
        const n = e[t].normal.split(X)[1];
        return n && Y.test(n) && !ee.test(n) ? ["du", n] : n && n.endsWith("s") ? ["des", n] : ["de", n]
    }
    ;
    const oe = /^([0-9.]{1,4}[a-z]{0,2}) ?[-–—] ?([0-9]{1,4}[a-z]{0,2})$/i
      , ae = /^([0-9]{1,2}(:[0-9][0-9])?(am|pm)?) ?[-–—] ?([0-9]{1,2}(:[0-9][0-9])?(am|pm)?)$/i
      , ie = /^[0-9]{3}-[0-9]{4}$/
      , se = function(e, t) {
        const n = e[t];
        let r = n.text.match(oe);
        return null !== r ? !0 === n.tags.has("PhoneNumber") || ie.test(n.text) ? null : [r[1], "to", r[2]] : (r = n.text.match(ae),
        null !== r ? [r[1], "to", r[4]] : null)
    }
      , le = /^([+-]?[0-9][.,0-9]*)([a-z°²³µ/]+)$/
      , ue = function(e, t, n) {
        const r = n.model.one.numberSuffixes || {}
          , o = e[t].text.match(le);
        if (null !== o) {
            const e = o[2].toLowerCase().trim();
            return r.hasOwnProperty(e) ? null : [o[1], e]
        }
        return null
    }
      , ce = /'/
      ...
      , ge = {
        ...
        d: (e, t) => function(e, t) {
            const n = e[t].normal.split(R)[0];
            if (Q.has(n))
                return [n, "did"];
            if (e[t + 1]) {
                if (_.has(e[t + 1].normal))
                    return [n, "had"];
                if (Z.has(e[t + 1].normal))
                    return [n, "would"]
            }
            return null
        }(e, t)
      ...
      , pe = function(e, t, n, r) {
        for (let o = 0; o < e.length; o += 1) {
            ...
            if (null !== n && n === a.before && r && r.length > 2)
        ...
        contractions: e => {
            ...
            n.forEach(( (r, i) => {
                for (let s = r.length - 1; s >= 0; s -= 1) {
                    ...
                    c ? (c = fe(c, e),
                    U(n, [i, s], c),
                    de(n[i], e, s, c.length)) : he.test(r[s].normal) ? (c = se(r, s),
                    c && (c = fe(c, e),
                    U(n, [i, s], c),
                    o.one.setTag(c, "NumberRange", t),
                    c[2] && c[2].tags.has("Time") && o.one.setTag([c[0]], "Time", t, null, "time-range"),
                    de(n[i], e, s, c.length))) : (c = ue(r, s, t),
                    c && (c = fe(c, e),
                    U(n, [i, s], c),
                    o.one.setTag([c[1]], "Unit", t, null, "contraction-unit")))
                }
            }
            ))
        }
            ...
            for (let n = 0; n < e.length; n += 1) {
                ...
                if (void 0 !== i[s] && e[n + 1]) {
                    for (let r = n + i[s] - 1; r > n; r -= 1) {
                        ...
                        !0 !== a.hasOwnProperty(s) || (o(i, a[s], t, !1, "1-frozen-multi-lexicon"),
                        i.forEach((e => e.frozen = !0)))
                    }
                }
                void 0 !== a[s] && a.hasOwnProperty(s) && (o([r], a[s], t, !1, "1-freeze-lexicon"),
                r.frozen = !0)
            }
        }
        ))
    ...
    const Ne = function(e, t, n) {
        ...
        if (void 0 !== i[u] && e[t + 1]) {
            for (let r = t + i[u] - 1; r > t; r -= 1) {
                ...
                if (o.length <= 1)
                    return !1;
                const i = o.map((e => e.machine || e.normal)).join(" ");
                if (!0 === s.hasOwnProperty(i)) {
                    const e = s[i];
                    return a(o, e, n, !1, "1-multi-lexicon"),
                    !e || 2 !== e.length || "PhrasalVerb" !== e[0] && "PhrasalVerb" !== e[1] || a([o[1]], "Particle", n, !1, "1-phrasal-particle"),
                    !0
                }
            }
            return !1
      ...
      , xe = new Set(["Verb", "Infinitive", "PastTense", "Gerund", "PresentTense", "Adjective", "Participle"])
      , Ie = function(e, t, n) {
        const {model: r, methods: o} = n
          , a = o.one.setTag
          , {lexicon: i} = r.one
        ...
        if (void 0 !== i[l] && i.hasOwnProperty(l))
            return a([s], i[l], n, !1, "1-lexicon"),
            !0;
        if (s.alias) {
            const e = s.alias.find((e => i.hasOwnProperty(e)));
            if (e)
                return a([s], i[e], n, !1, "1-lexicon-alias"),
                !0
        }
        if (!0 === je.test(l)) {
            const e = l.replace(je, "");
            if (i.hasOwnProperty(e) && e.length > 3 && xe.has(i[e]))
                return a([s], i[e], n, !1, "1-lexicon-prefix"),
                !0
        }
        return null
    };
        ...
        one: {
            expandLexicon: function(e) {
                ...
                return Object.keys(e).forEach((r => {
                    const o = e[r]
                      , a = (r = (r = r.toLowerCase().trim()).replace(/'s\b/, "")).split(/ /);
                    a.length > 1 && (void 0 === n[a[0]] || a.length > n[a[0]]) && (n[a[0]] = a.length),
                    t[r] = t[r] || o
                }
                )),
                delete t[""],
    ...
    var He = {
        addWords: function(e, t=!1) {
            ...
            !0 === t) {
                const {lex: t, _multi: a} = r.one.expandLexicon(e, n);
                return Object.assign(o.one._multiCache, a),
                void Object.assign(o.one.frozenLex, t)
            }
            if (r.two.expandLexicon) {
                const {lex: t, _multi: a} = r.two.expandLexicon(e, n);
                Object.assign(o.one.lexicon, t),
                Object.assign(o.one._multiCache, a)
            }
            const {lex: a, _multi: i} = r.one.expandLexicon(e, n);
            Object.assign(o.one.lexicon, a),
            Object.assign(o.one._multiCache, i)
        }
    };
    var Ee = {
        model: {
    ...
    const Ge = function(e, t) {
        ...
        e.forEach((function(e) {
            ...
            const a = function(e, t) {
                const {methods: n, model: r} = t
                  , o = n.one.tokenize.splitTerms(e, r).map((e => n.one.tokenize.splitWhitespace(e, r)));
                return o.map((e => e.text.toLowerCase()))
            }(e, t);
            for (let e = 0; e < a.length; e++) {
                const t = a[e];
                n[o] && n[o].hasOwnProperty(t) ? o = n[o][t] : (i++,
                n[o][t] = i,
                n[i] = {},
                o = i,
                r[i] = null)
        ...
        for (; a.length; ) {
            ...
            for (let s = 0; s < t.length; s += 1) {
                const l = t[s]
                  , u = n[e][l];
                for (a.push(u),
                i = o[e]; i > 0 && !n[i].hasOwnProperty(l); )
                    i = o[i];
      ...
      , Oe = function(e, t, n) {
        ...
        for (let a = 0; a < e.length; a++) {
            ...
            for (; r > 0 && (void 0 === t.goNext[r] || !t.goNext[r].hasOwnProperty(i)); )
                r = t.failTo[r] || 0;
            if (t.goNext[r].hasOwnProperty(i) && (r = t.goNext[r][i],
            t.endAs[r])) {
                const n = t.endAs[r];
            ...
            e.prototype.lookup = function(e, t={}) {
                ...
                let r = function(e, t, n) {
                    ...
                    if (!t.goNext || !t.goNext[0])
                        return console.error("Compromise invalid lookup trie"),
                        e.none();
                    const a = Object.keys(t.goNext[0]);
                    for (let i = 0; i < o.length; i++) {
                        if (e._cache && e._cache[i] && !0 === Fe(a, e._cache[i]))
                            continue;
                        const s = o[i]
                          , l = Oe(s, t, n);
                ...
                "[object Object]" === Object.prototype.toString.call(n) ? e : Ge(e, this.world)), t);
                return r = r.settle(),
                r
            }
        },
    ...
    const Se = function(e, t) {
      ...
      , Me = function(e, t, n) {
        ...
        "string" == typeof e && (e = r.killUnicode(e, n),
        e = r.parseMatch(e, t, n)),
        e
    }
    ...
    var We = {
        matchOne: function(e, t, n) {
            ...
            const o = {
                regs: e = Me(e, n, this.world),
                group: t,
                justOne: !0
            }
              , a = r.match(this.docs, o, this._cache)
              , {ptrs: i, byGroup: s} = $e(a, this.fullPointer)
              , l = this.toView(i);
            return l._groups = s,
            l
        },
        ...
        if: function(e, t, n) {
            const r = this.methods.one;
            if (Ke(e))
                return this.filter((t => t.intersection(e).found));
            if (Je(e)) {
                const t = this.sweep(e, {
                    tagger: !1
                }).view.settle();
                return this.if(t)
            }
            ...
            const i = this._cache || [];
            a = a.filter(( (e, t) => {
                const n = this.update([e]);
                return r.match(n.docs, o, i[t]).ptrs.length > 0
            }
            ));
            const s = this.update(a);
            return this._cache && (s._cache = a.map((e => i[e[0]]))),
            s
        },
        ifNo: function(e, t, n) {
            ...
            const a = this._cache || []
              , i = this.filter(( (n, r) => {
                ...
                return 0 === o.match(n.docs, i, a[r]).ptrs.length
            }
            ));
            return this._cache && (i._cache = i.ptrs.map((e => a[e[0]]))),
            i
        }
    };
    var qe = {
        before: function(e, t, n) {
            const {indexN: r} = this.methods.one.pointer
              , o = []
              , a = r(this.fullPointer);
            Object.keys(a).forEach((e => {
                const t = a[e].sort(( (e, t) => e[1] > t[1] ? 1 : -1))[0];
                t[1] > 0 && o.push([t[0], 0, t[1]])
            }
            ));
        ...
        after: function(e, t, n) {
            ...
            Object.keys(a).forEach((e => {
                const t = a[e].sort(( (e, t) => e[1] > t[1] ? -1 : 1))[0]
                  , [n,,r] = t;
                r < i[n].length && o.push([n, r, i[n].length])
            }
            ));
        ...
        growLeft: function(e, t, n) {
            "string" == typeof e && (e = this.world.methods.one.parseMatch(e, n, this.world)),
            e[e.length - 1].end = !0;
            const r = this.fullPointer;
            return this.forEach(( (n, o) => {
                const a = n.before(e, t);
                if (a.found) {
                    const e = a.terms();
                    r[o][1] -= e.length,
                    r[o][3] = e.docs[0][0].id
    ...
    const Ue = function(e, t) {
      ...
      , Re = (e, t, n) => {
        ...
        "[object Array]" === Object.prototype.toString.call(r)) ? t.match(e, n) : e || t.none();
        var r
    }
      , Qe = function(e, t) {
        const [n,r,o] = e;
        return t.document[n] && t.document[n][r] && (e[3] = e[3] || t.document[n][r].id,
        t.document[n][o - 1] && (e[4] = e[4] || t.document[n][o - 1].id)),
        e
    }
      , Ze = {
        splitOn: function(e, t) {
            const {splitAll: n} = this.methods.one.pointer
              , r = Re(e, this, t).fullPointer
              , o = n(this.fullPointer, r);
            let a = [];
            return o.forEach((e => {
                a.push(e.passthrough),
                a.push(e.before),
                a.push(e.match),
                a.push(e.after)
            }
        ...
        splitBefore: function(e, t) {
            ...
            for (let e = 0; e < o.length; e += 1)
                !o[e].after && o[e + 1] && o[e + 1].before && o[e].match && o[e].match[0] === o[e + 1].before[0] && (o[e].after = o[e + 1].before,
                delete o[e + 1].before);
            let a = [];
            return o.forEach((e => {
                a.push(e.passthrough),
                a.push(e.before),
                e.match && e.after ? a.push(Ue(e.match, e.after)) : a.push(e.match)
            }
            )),
            a = a.filter((e => e)),
            a = a.map((e => Qe(e, this))),
        ...
        splitAfter: function(e, t) {
            ...
            return o.forEach((e => {
                a.push(e.passthrough),
                e.before && e.match ? a.push(Ue(e.before, e.match)) : (a.push(e.before),
                a.push(e.match)),
                a.push(e.after)
            }
            )),
    ...
    const _e = function(e, t) {
      ...
      , Xe = function(e, t, n) {
        const r = e.world
          , o = r.methods.one.parseMatch;
        n = n || "^.";
        const a = o(t = t || ".$", {}, r)
          , i = o(n, {}, r);
        a[a.length - 1].end = !0,
        i[0].start = !0;
        const s = e.fullPointer
          , l = [s[0]];
        for (let t = 1; t < s.length; t += 1) {
            const n = l[l.length - 1]
              ...
              , o = e.update([n])
              , u = e.update([r]);
            _e(n, r) && o.has(a) && u.has(i) ? l[l.length - 1] = [n[0], n[1], r[2], n[3], r[4]] : l.push(r)
        }
        return e.update(l)
    }
      , Ye = {
    ...
    const tt = /(?:^|\s)([![^]*(?:<[^<]*>)?\/.*?[^\\/]\/[?\]+*$~]*)(?:\s|$)/
      ...
      , pt = function(e, t) {
        ...
        for (let r = 0; r < 2; r += 1) {
            ...
            "?" === ct(e) && (n.optional = !0,
            e = gt(e)),
            ("[" === ht(e) || "]" === ct(e)) && (n.group = null,
            "[" === ht(e) && (n.groupStart = !0),
            "]" === ct(e) && (n.groupEnd = !0),
            e = (e = e.replace(/^\[/, "")).replace(/\]$/, ""),
            "<" === ht(e))) {
                const t = lt.exec(e);
                t.length >= 2 && (n.group = t[1],
                e = e.replace(t[0], ""))
            }
            if ("+" === ct(e) && (n.greedy = !0,
            e = gt(e)),
            ...
            if ("/" === ht(e) && "/" === ct(e))
                ...
                n;
            if (!0 === it.test(e) && (e = e.replace(it, ( (e, t, r) => (void 0 === r ? (n.min = Number(t),
            n.max = Number(t)) : (r = r.replace(/, */, ""),
            void 0 === t ? (n.min = 0,
            n.max = Number(r)) : (n.min = Number(t),
            n.max = Number(r || 999))),
            n.greedy = !0,
            n.min || (n.optional = !0),
            "")))),
            "(" === ht(e) && ")" === ct(e)) {
                st.test(e) ? (n.choices = e.split(st),
                n.operator = "and") : (n.choices = e.split("|"),
                n.operator = "or"),
                n.choices[0] = dt(n.choices[0]);
                const r = n.choices.length - 1;
                n.choices[r] = gt(n.choices[r]),
                n.choices = n.choices.map((e => e.trim())),
                n.choices = n.choices.filter((e => e)),
                n.choices = n.choices.map((e => e.split(/ /g).map((e => pt(e, t))))),
                e = ""
            }
            if ("{" === ht(e) && "}" === ct(e)) {
                if (e = mt(e),
                n.root = e,
                /\//.test(e)) {
                    const e = n.root.split(/\//);
                    n.root = e[0],
                    n.pos = e[1],
                    "adj" === n.pos && (n.pos = "Adjective"),
                    n.pos = n.pos.charAt(0).toUpperCase() + n.pos.substr(1).toLowerCase(),
        ...
        return "#" === ht(e) ? (n.tag = dt(e),
        n.tag = ut(n.tag),
        n) : "@" === ht(e) ? (n.method = dt(e),
        n) : "." === e ? (n.anything = !0,
        n) : "*" === e ? (n.anything = !0,
        n.greedy = !0,
        n.optional = !0,
        n) : (e && (e = (e = e.replace("\\*", "*")).replace("\\.", "."),
      ...
      , ft = /[a-z0-9][-–—][a-z]/i
      , bt = function(e, t) {
        const {all: n} = t.methods.two.transform.verb || {}
          , r = e.root;
      ...
      , wt = function(e) {
        ...
        e = function(e) {
            return e.map((e => (e.fuzzy && e.choices && e.choices.forEach((t => {
                1 === t.length && t[0].word && (t[0].fuzzy = !0,
                t[0].min = e.min)
            }
            )),
            e)))
      ...
      , Pt = function(e, t) {
        for (let n = 0; n < e.length; n += 1) {
            ...
            if (!0 !== r.optional && !0 !== r.negative && !0 !== r.fuzzy) {
                if (void 0 !== r.word && !1 === t.has(r.word))
                    return !0;
                if (void 0 !== r.tag && !1 === t.has("#" + r.tag))
                    return !0;
                if (r.fastOr && !1 === kt(r.fastOr, t))
                    return !1
            }
        }
        return !1
        ...
        const r = function(e, t) {
            ...
            for (let o = 1; o <= n; ++o)
                ...
                i = 1; i <= r; ++i) {
                    ...
                    (h = a[o][i - 1] + 1) < c && (c = h),
                    (h = a[o - 1][i - 1] + u) < c && (c = h);
                    const r = o > 1 && i > 1 && s === t[i - 2] && e[o - 2] === l && (h = a[o - 2][i - 2] + u) < c;
                    a[o][i] = r ? h : c
                }
            return a[n][r]
        }(e, t)
    ...
    Dt = function(e, t, n, r) {
        const o = function(e, t, n, r) {
            ...
            if (void 0 !== t.word) {
                if (t.use)
                    return t.word === e[t.use];
                if (null !== e.machine && e.machine === t.word)
                    return !0;
                if (void 0 !== e.alias && e.alias.hasOwnProperty(t.word))
                    return !0;
                if (!0 === t.fuzzy) {
                    if (t.word === e.root)
                        return !0;
                    if (At(t.word, e.normal) >= t.min)
                        return !0
                }
                return !(!e.alias || !e.alias.some((e => e === t.word))) || t.word === e.text || t.word === e.normal
            }
            if (void 0 !== t.tag)
                return !0 === e.tags.has(t.tag);
            if (void 0 !== t.method)
            ...
            if (void 0 !== t.fastOr) {
                if (t.pos && !e.tags.has(t.pos))
                    return null;
                const n = e.root || e.implicit || e.machine || e.normal;
                return t.fastOr.has(n) || t.fastOr.has(e.text)
            }
            return void 0 !== t.choices && ("and" === t.operator ? t.choices.every((t => Dt(e, t, n, r))) : t.choices.some((t => Dt(e, t, n, r))))
        }(e, t, n, r);
        return !0 === t.negative ? !o : o
    }
    ;
    const Ht = function(e, t) {
      ...
      , Gt = function(e) {
        ...
        if (null === r || 0 === r)
            return null;
        if (void 0 !== n.min && r - e.t < n.min)
            return null;
        if (void 0 !== n.max && r - e.t > n.max)
            return e.t = e.t + n.max,
            !0;
        if (!0 === e.hasGroup) {
            Et(e, e.t).length = r - e.t
        }
        return e.t = r,
        !0
    }
      , Ot = function(e, t=0) {
        const n = e.regs[e.r];
        let r = !1;
        for (let a = 0; a < n.choices.length; a += 1) {
            const i = n.choices[a];
            if (o = i,
            "[object Array]" !== Object.prototype.toString.call(o))
                return !1;
            if (r = i.every(( (n, r) => {
                ...
                if (void 0 === e.terms[a])
                    return !1;
                const i = Dt(e.terms[a], n, a + e.start_i, e.phrase_length);
                if (!0 === i && !0 === n.greedy)
                    for (let t = 1; t < e.terms.length; t += 1) {
                        const r = e.terms[a + t];
                        if (r) {
                            if (!0 !== Dt(r, n, e.start_i + t, e.phrase_length))
                                break;
                            o += 1
                        }
                    }
      ...
      , Ft = function(e) {
        ...
        if (r) {
            ...
            if (!0 === n.end) {
                const t = e.phrase_length;
                if (e.t + e.start_i + r !== t)
                    return null
            }
            return e.t += r,
            !0
        ...
        const {regs: t} = e
          ...
          , r = function(e) {
            ...
            return !0 === e.regs[e.r].choices.every((n => {
                const r = n.every(( (t, n) => {
                    const r = e.t + n;
                    return void 0 !== e.terms[r] && Dt(e.terms[r], t, r, e.phrase_length)
                }
                ));
                return !0 === r && n.length > t && (t = n.length),
                r
            }
            )) && t
        }(e);
      ...
      , zt = function(e) {
        const {regs: t} = e
          ...
          , r = Object.assign({}, n);
        r.negative = !1;
        if (Dt(e.terms[e.t], r, e.start_i + e.t, e.phrase_length))
            return !1;
        if (n.optional) {
            const n = t[e.r + 1];
            if (n) {
                if (Dt(e.terms[e.t], n, e.start_i + e.t, e.phrase_length))
                    e.r += 1;
                else if (n.optional && t[e.r + 2]) {
                    Dt(e.terms[e.t], t[e.r + 2], e.start_i + e.t, e.phrase_length) && (e.r += 2)
                }
            }
        }
        return n.greedy ? function(e, t, n) {
            let r = 0;
            for (let o = e.t; o < e.terms.length; o += 1) {
                let a = Dt(e.terms[o], t, e.start_i + e.t, e.phrase_length);
                if (a)
                    break;
                if (n && (a = Dt(e.terms[o], n, e.start_i + e.t, e.phrase_length),
                a))
                    break;
                if (r += 1,
                void 0 !== t.max && r === t.max)
                    break
            }
            return !(0 === r || t.min && t.min > r || (e.t += r,
            0))
        }(e, r, t[e.r + 1]) : (e.t += 1,
        !0)
    }
      , Bt = function(e) {
        ...
        return e.t = function(e, t) {
            const n = Object.assign({}, e.regs[e.r], {
                start: !1,
                end: !1
            })
              , r = e.t;
            for (; e.t < e.terms.length; e.t += 1) {
                if (t && Dt(e.terms[e.t], t, e.start_i + e.t, e.phrase_length))
                    return e.t;
                const o = e.t - r + 1;
                if (void 0 !== n.max && o === n.max)
                    return e.t;
                if (!1 === Dt(e.terms[e.t], n, e.start_i + e.t, e.phrase_length))
                    return void 0 !== n.min && o < n.min ? null : e.t
            }
            return e.t
        }(e, t[e.r + 1]),
        null === e.t || r.min && r.min > e.t ? null : !0 !== r.end || e.start_i + e.t === n || null
    }
      , St = function(e) {
        const {regs: t} = e
          , n = t[e.r]
          , r = e.terms[e.t]
          , o = e.t;
        if (n.optional && t[e.r + 1] && n.negative)
            return !0;
        if (n.optional && t[e.r + 1] && function(e) {
            const {regs: t} = e
              , n = t[e.r]
              , r = e.terms[e.t]
              , o = Dt(r, t[e.r + 1], e.start_i + e.t, e.phrase_length);
            if (n.negative || o) {
                const n = e.terms[e.t + 1];
                n && Dt(n, t[e.r + 1], e.start_i + e.t, e.phrase_length) || (e.r += 1)
            }
        }(e),
        r.implicit && e.terms[e.t + 1] && function(e) {
            const t = e.terms[e.t]
              , n = e.regs[e.r];
        ...
        return !0 === e.hasGroup && function(e, t) {
            const n = e.regs[e.r]
              , r = Et(e, t);
      ...
      , $t = function(e, t, n, r) {
        ...
        for (; o.r < t.length; o.r += 1) {
            const e = t[o.r];
            if (o.hasGroup = Boolean(e.group),
            !0 === o.hasGroup ? o.inGroup = e.group : o.inGroup = null,
            !o.terms[o.t]) {
                if (!1 === t.slice(o.r).some((e => !e.optional)))
                    break;
                return null
            }
            ...
            if (!0 !== Dt(o.terms[o.t], e, o.start_i + o.t, o.phrase_length)) {
                if (!0 !== e.optional)
                    return null
            } else {
                if (!St(o))
        ...
        if (a[1] === a[2])
            return null;
        const i = {};
        return Object.keys(o.groups).forEach((e => {
            const t = o.groups[e]
              , r = n + t.start;
        ...
        one: {
            ...
            parseMatch: function(e, t, n) {
                ...
                let r = function(e) {
                    ...
                    let n = [];
                    t.forEach((e => {
                        ot(e) ? n.push(e) : n = n.concat(e.split(nt))
                    }
                    )),
                    n = at(n);
                    let r = [];
                    return n.forEach((e => {
                        (e => /^[![^]*(<[^<]*>)?\(/.test(e) && /\)[?\]+*$~]*$/.test(e))(e) || ot(e) ? r.push(e) : r = r.concat(e.split(rt))
                    }
                    )),
                    r = at(r),
                    r
                }(e);
                return r = r.map((e => pt(e, t))),
                r = function(e, t) {
                    const n = t.model.one.prefixes;
                    for (let t = e.length - 1; t >= 0; t -= 1) {
                        const r = e[t];
                        if (r.word && ft.test(r.word)) {
                            let o = r.word.split(/[-–—]/g);
                    ...
                    return e.map((e => {
                        if (e.root)
                            if (t.methods.two && t.methods.two.transform) {
                                let n = [];
                                e.pos ? "Verb" === e.pos ? n = n.concat(bt(e, t)) : "Noun" === e.pos ? n = n.concat(vt(e, t)) : "Adjective" === e.pos && (n = n.concat(yt(e, t))) : (n = n.concat(bt(e, t)),
                                n = n.concat(vt(e, t)),
                                n = n.concat(yt(e, t))),
                                n = n.filter((e => e)),
                                n.length > 0 && (e.operator = "or",
                                e.fastOr = new Set(n))
                            } else
                                e.machine = e.root,
                                delete e.id,
            ...
            match: function(e, t, n) {
                ...
                t.notIf && (i = function(e, t, n) {
                    return e = e.filter((e => {
                        const [r,o,a] = e.pointer
                          , i = n[r].slice(o, a);
                        for (let e = 0; e < i.length; e += 1) {
                            const n = i.slice(e);
                            if (null !== $t(n, t, e, i.length))
                                return !1
                        }
                        return !0
                    }
                ...
                i = function(e, t) {
                    const n = []
                      , r = {};
                    return 0 === e.length || ("number" == typeof t && (t = String(t)),
                    t ? e.forEach((e => {
    ...
    var Jt = {
        ...
        lib: {
            parseMatch: function(e, t) {
                const n = this.world()
                  , r = n.methods.one.killUnicode;
                return r && (e = r(e, n)),
                n.methods.one.parseMatch(e, t, n)
            }
        }
    };
    const Wt = /^\../
      ...
      , Ut = function(e, t) {
        ...
        return Object.keys(t).forEach((o => {
            ...
            const i = function(e) {
                ...
                Wt.test(e) ? t = `<span class="${e.replace(/^\./, "")}"` : qt.test(e) ? t = `<span id="${e.replace(/^#/, "")}"` : (t = `<${e}`,
                n = `</${e}>`),
                t += ">",
                {
                    start: t,
            ...
            "string" == typeof a && (a = e.match(a)),
            a.docs.forEach((e => {
                if (e.every((e => e.implicit)))
                    return;
                const t = e[0].id;
                n[t] = n[t] || [],
                n[t].push(i.start);
                const o = e[e.length - 1].id;
                r[o] = r[o] || [],
                r[o].push(i.end)
            }
            ))
    ...
    var Rt = {
        html: function(e) {
            const {starts: t, ends: n} = Ut(this, e);
            let r = "";
            return this.docs.forEach((e => {
                for (let o = 0; o < e.length; o += 1) {
                    const a = e[o];
                    t.hasOwnProperty(a.id) && (r += t[a.id].join("")),
                    r += a.pre || "",
                    r += a.text || "",
                    n.hasOwnProperty(a.id) && (r += n[a.id].join("")),
                    r += a.post || ""
                }
            }
            )),
    ...
    const Qt = /[,:;)\]*.?~!\u0022\uFF02\u201D\u2019\u00BB\u203A\u2032\u2033\u2034\u301E\u00B4—-]+$/
      ...
      , en = function(e, t, n=!0) {
        ...
        return e.forEach((e => {
            let n = e.pre || ""
              , o = e.post || "";
            "some" === t.punctuation && (n = n.replace(Zt, ""),
            Xt.test(o) && (o = " "),
            o = o.replace(_t, ""),
            o = o.replace(/\?!+/, "?"),
            o = o.replace(/!+/, "!"),
            o = o.replace(/\?+/, "?"),
            o = o.replace(/\.{2,}/, ""),
            e.tags.has("Abbreviation") && (o = o.replace(/\./, ""))),
            "some" === t.whitespace && (n = n.replace(/\s/, ""),
            o = o.replace(/\s+/, " ")),
            t.keepPunct || (n = n.replace(Zt, ""),
            o = "-" === o ? " " : o.replace(Qt, ""));
            let a = e[t.form || "text"] || e.normal || "";
            "implicit" === t.form && (a = e.implicit || e.text),
            "root" === t.form && e.implicit && (a = e.root || e.implicit || e.normal),
            "machine" !== t.form && "implicit" !== t.form && "root" !== t.form || !e.implicit || o && Yt.test(o) || (o += " "),
            r += n + a + o
        }
        )),
        !1 === n && (r = r.trim()),
    ...
    let rn = 0;
    for (; rn < 64; )
        nn[rn] = 0 | 4294967296 * Math.sin(++rn % Math.PI);
    const on = function(e) {
        let t, n, r, o = decodeURI(encodeURI(e)) + "", a = o.length;
        const i = [t = 1732584193, n = 4023233417, ~t, ~n]
          , s = [];
        for (e = --a / 4 + 2 | 15,
        s[--e] = 8 * a; ~a; )
            s[a >> 2] |= o.charCodeAt(a) << 8 * a--;
        for (rn = o = 0; rn < e; rn += 16) {
            for (a = i; o < 64; a = [r = a[3], t + ((r = a[0] + [t & n | ~t & r, r & t | ~r & n, t ^ n ^ r, n ^ (t | ~r)][a = o >> 4] + nn[o] + ~~s[rn | 15 & [o, 5 * o + 1, 3 * o + 5, 7 * o][a]]) << (a = [7, 12, 17, 22, 5, 9, 14, 20, 4, 11, 16, 23, 6, 10, 15, 21][4 * a + o++ % 4]) | r >>> -a), t, n])
                t = 0 | a[1],
                n = a[2];
            for (o = 4; o; )
                i[--o] += a[o]
      ...
      , un = {
        ...
        normal: e => en(e, ln(tn.normal, {
            keepPunct: !0
        }), !1),
        implicit: e => en(e, ln(tn.implicit, {
            keepPunct: !0
        }), !1),
        machine: e => en(e, sn, !1),
        root: e => en(e, ln(sn, {
        ...
        terms: e => e.map((e => {
            ...
            return t.tags = Array.from(e.tags),
            t
        }
        )),
    ...
    const cn = {
        json: function(e) {
            ...
            (r = Object.assign({}, an, r)).offset && n.compute("offset"),
            n.docs.map(( (e, t) => {
                const o = {};
                return Object.keys(r).forEach((a => {
                    r[a] && un[a] && (o[a] = un[a](e, n, t))
                }
                )),
                o
            }
    ...
    const hn = function(e) {
      ...
      , dn = function(e, t) {
        ...
        let r = "";
        return e.docs.forEach(( (t, o) => {
            for (let a = 0; a < t.length; a += 1) {
                const i = t[a];
                if (n.hasOwnProperty(i.id)) {
                    const {fn: s, end: l} = n[i.id]
                      , u = e.update([[o, a, l]]);
                    r += t[a].pre || "",
                    r += s(u),
                    a = l - 1,
      ...
      , gn = {
        debug: function(e) {
            ...
            return e && t.hasOwnProperty(e) ? (t[e](this),
            this) : "undefined" != typeof window && window.document ? (t.clientSide(this),
            this) : (t.tags(this),
            this)
        },
        out: function(e) {
            ...
            if ("array" === e) {
                const e = this.docs.map((e => e.reduce(( (e, t) => e + t.pre + t.text + t.post), "").trim()));
                return e.filter((e => e))
            }
            ...
            return "tags" === e ? this.docs.map((e => e.reduce(( (e, t) => (e[t.implicit || t.normal] = Array.from(t.tags),
            e)), {}))) : "debug" === e ? this.debug() : this.text()
        },
        wrap: function(e) {
            return dn(this, e)
        }
    ...
    var mn = {
        text: function(e) {
            let t = {};
            var n;
            if (e && "string" == typeof e && tn.hasOwnProperty(e) ? t = Object.assign({}, tn[e]) : e && (n = e,
            "[object Object]" === Object.prototype.toString.call(n)) && (t = Object.assign({}, e)),
            void 0 !== t.keepSpace || this.isFull() || (t.keepSpace = !1),
            void 0 === t.keepEndPunct && this.pointer) {
                const e = this.pointer[0];
                e && e[1] ? t.keepEndPunct = !1 : t.keepEndPunct = !0
            }
            return void 0 === t.keepPunct && (t.keepPunct = !0),
            ...
            function(e, t) {
                ...
                for (let r = 0; r < e.length; r += 1)
                    n += en(e[r], t, !0);
                if (t.keepSpace || (n = n.trim()),
                !1 === t.keepEndPunct) {
                    e[0][0].tags.has("Emoticon") || (n = n.replace(Zt, ""));
                    const t = e[e.length - 1];
                    t[t.length - 1].tags.has("Emoticon") || (n = n.replace(Qt, "")),
                    n.endsWith("'") && !n.endsWith("s'") && (n = n.replace(/'/, ""))
                }
                return !0 === t.cleanWhitespace && (n = n.trim()),
                n
            }(this.docs, t)
        }
    };
      ...
      , vn = {
        tags: function(e) {
            ...
            t.forEach((t => {
                ...
                t.forEach((t => {
                    const r = [...t.tags || []];
                    let o = t.text || "-";
                    t.sense && (o = `{${t.normal}/${t.sense}}`),
                    t.implicit && (o = "[" + t.implicit + "]"),
                    o = bn.yellow(o);
                    let a = "'" + o + "'";
                    if (t.reference) {
                        const n = e.update([t.reference]).text("normal");
                        a += ` - ${bn.dim(bn.i("[" + n + "]"))}`
                    }
                    a = a.padEnd(18);
                    const i = bn.blue("  │ ") + bn.i(a) + "  - " + function(e, t) {
                        return t.one.tagSet && (e = e.map((e => {
                            if (!t.one.tagSet.hasOwnProperty(e))
                                return e;
        ...
        chunks: function(e) {
            ...
            t.forEach((e => {
                const t = [];
                e.forEach((e => {
                    "Noun" === e.chunk ? t.push(bn.blue(e.implicit || e.normal)) : "Verb" === e.chunk ? t.push(bn.green(e.implicit || e.normal)) : "Adjective" === e.chunk ? t.push(bn.yellow(e.implicit || e.normal)) : "Pivot" === e.chunk ? t.push(bn.red(e.implicit || e.normal)) : t.push(e.implicit || e.normal)
                }
                )),
                console.log(t.join(" "), "\n")
            }
                    ...
                    r = function(e, t, n) {
                        const r = ( (e, t, n) => {
                            const r = 9 * n
                              , o = t.start + r
                              , a = o + t.length;
                            return [e.substring(0, o), e.substring(o, a), e.substring(a, e.length)]
                        }
                        )(e, t, n);
            ...
            getDoc: function(e, t) {
                ...
                return e.forEach(( (r, o) => {
                    ...
                    !l || c[i] && c[i].id === l)
                        ...
                        const n = function(e, t, n) {
                            for (let r = 0; r < 20; r += 1) {
                                if (t[n - r]) {
                                    const o = t[n - r].findIndex((t => t.id === e));
                                    if (-1 !== o)
                                        return [n - r, o]
                                }
                                if (t[n + r]) {
                    ...
                    0 !== c.length && i !== s && (u && c[c.length - 1].id !== u && (c = function(e, t) {
                        const [n,r,,,o] = e
                          , a = t[n]
                          , i = a.findIndex((e => e.id === o));
                        return -1 === i ? (e[2] = t[n].length,
                        e[4] = a.length ? a[a.length - 1].id : null) : e[2] = i,
                        t[n].slice(r, e[2] + 1)
                    }(r, t)),
                    n.push(c))
                }
    ...
    const Cn = function(e, t) {
      ...
      , jn = (e, t) => {
        ...
        "[object Array]" === Object.prototype.toString.call(n)) ? t.match(e) : e || t.none();
        var n
    }
      , xn = function(e, t) {
        return e.map((e => {
            const [n,r] = e;
            return t[n] && t[n][r] && (e[3] = t[n][r].id),
            e
        }
        ))
    }
    ...
    In.complement = function() {
        const e = this.all();
        let t = Nn(e.fullPointer, this.fullPointer);
        return t = xn(t, this.document),
        this.toView(t)
    }
    ,
      ...
      , Hn = function(e, t) {
        ...
        return e.forEach((e => {
            ...
            e.needs = function(e) {
                ...
                return e.forEach((e => {
                    t.push(Dn(e)),
                    "and" === e.operator && e.choices && e.choices.forEach((e => {
                        e.forEach((e => {
                            t.push(Dn(e))
                        }
                        ))
            ...
            const {wants: r, count: o} = function(e) {
                const t = [];
                let n = 0;
                return e.forEach((e => {
    ...
    var En = {
        buildNet: function(e, t) {
            ...
            Object.keys(n).forEach((e => {
                const t = {};
                n[e] = n[e].filter((e => "boolean" != typeof t[e.match] && (t[e.match] = !0,
                !0)))
            }
            ));
            const r = e.filter((e => 0 === e.needs.length && 0 === e.wants.length));
            return {
                hooks: n,
                always: r
            }
        ...
        bulkMatch: function(e, t, n, r={}) {
            ...
            let a = function(e, t) {
                return e.map(( (n, r) => {
                    let o = [];
                    Object.keys(t).forEach((n => {
                        e[r].has(n) && (o = o.concat(t[n]))
                    }
                    ));
                    const a = {};
                    return o = o.filter((e => "boolean" != typeof a[e.match] && (a[e.match] = !0,
                    !0))),
                    o
                }
                ))
            ...
            a = function(e, t) {
                return e.map(( (e, n) => {
                    const r = t[n];
                    return (e = (e = e.filter((e => e.needs.every((e => r.has(e)))))).filter((e => void 0 === e.ifNo || !0 !== e.ifNo.some((e => r.has(e)))))).filter((e => 0 === e.wants.length || e.wants.filter((e => r.has(e))).length >= e.minWant))
                }
                ))
            }(a, o),
            t.always.length > 0 && (a = a.map((e => e.concat(t.always)))),
            a = function(e, t) {
                return e.map(( (e, n) => {
                    const r = t[n].length;
                    return e = e.filter((e => r >= e.minWords)),
                    e
                }
                ))
            }(a, e);
                ...
                for (let n = 0; n < e.length; n += 1)
                    for (let i = 0; i < e[n].length; i += 1) {
                        ...
                        if (l.ptrs.length > 0 && (l.ptrs.forEach((e => {
                            ...
                            void 0 !== s.unTag && (t.unTag = s.unTag),
                            a.push(t)
                        }
                        )),
                        !0 === o.matchOne))
            ...
            e.map((e => {
                ...
                if (!0 === e.safe) {
                    if (!1 === function(e, t, n) {
                        ...
                        return;
                    if ("-" === u[u.length - 1].post)
                        return
                }
                if (void 0 !== e.tag) {
                    if (i(u, e.tag, n, e.safe, `[post] '${o}'`),
                    "Noun" === e.tag && l) {
                ...
                void 0 !== e.unTag && s(u, e.unTag, n, e.safe, o),
      ...
      , Gn = {
        lib: {
            buildNet: function(e) {
                const t = this.methods().one.buildNet(e, this.world());
                return t.isNet = !0,
                t
            }
        },
        api: function(e) {
            e.prototype.sweep = function(e, t={}) {
                const {world: n, docs: r} = this
                  , {methods: o} = n;
                let a = o.one.bulkMatch(r, e, this.methods, t);
                !1 !== t.tagger && o.one.bulkTagger(a, r, this.world),
                a = a.map((e => {
                    const t = e.pointer
                      , n = r[t[0]][t[1]]
                      , o = t[2] - t[1];
                    return n.index && (e.pointer = [n.index[0], n.index[1], t[1] + o]),
                    e
                }
                ));
                const i = a.map((e => e.pointer));
                return a = a.map((e => (e.view = this.update([e.pointer]),
                delete e.regs,
                delete e.needs,
                delete e.pointer,
                delete e._expanded,
    ...
    const On = / /
      ...
      , Vn = function(e, t, n, r) {
        ...
        if (o) {
            if (o.not && o.not.length > 0)
                for (let t = 0; t < o.not.length; t += 1) {
                    if (!0 === r && e.tags.has(o.not[t]))
                        return null;
                    e.tags.delete(o.not[t])
                }
            if (o.parents && o.parents.length > 0)
                for (let t = 0; t < o.parents.length; t += 1)
                    e.tags.add(o.parents[t]),
                    Fn(e, o.parents[t])
        }
        return e.tags.add(t),
        e.dirty = !0,
      ...
      , zn = function(e, t, n={}, r, o) {
        ...
        if (i && i.DEBUG_TAGS && ( (e, t, n="") => {
            const r = e.map((e => e.text || "[" + e.implicit + "]")).join(" ");
            var o;
            "string" != typeof t && t.length > 2 && (t = t.slice(0, 2).join(", #") + " +"),
            t = "string" != typeof t ? t.join(", #") : t,
            console.log(` ${(o = r,
            "[33m[3m" + o + "[0m").padEnd(24)} [32m→[0m #${t.padEnd(22)}  ${(e => "[3m" + e + "[0m")(n)}`)
        }
        )(e, t, o),
        !0 != (s = t,
        ...
        t.forEach((e => {
            n = n.concat(function(e) {
                ...
                if (/^\[/.test(e) && /\]$/.test(e)) {
                    ...
                    return t = t.map((e => e.trim())).filter((e => e)),
                    t = t.map((e => Bn({
                        id: e
                    }))),
                    t
            ...
            return e.forEach((e => {
                if ((e = Bn(e)).parent)
                    if (t.hasOwnProperty(e.parent)) {
                        ...
                        console.warn(`[Grad] - missing node '${e.parent}'`);
                else
                    n.children.push(e)
            }
            )),
      ...
      , qn = function(e) {
        ...
        let n = t[0];
        return n && !n.id && 0 === Object.keys(n.props).length && t.shift(),
        t
    }
      , Un = {
        text: Wn,
      ...
      , Rn = function(e, t) {
        return "nested" === t || "json" === t ? e : "debug" === t ? (console.log(Wn(e, !0)),
        null) : Un.hasOwnProperty(t) ? Un[t](e) : e
    }
      , Qn = e => {
        Mn(e, ( (e, t) => {
            e.id && (e._cache.parents = e._cache.parents || [],
    ...
    let _n = class g {
        ...
        add(e, t={}) {
            if (Ln(e))
                return e.forEach((e => this.add(Kn(e), t))),
                this;
            e = Kn(e);
            let n = Bn({
                id: e,
            ...
            return this.json.children.push(n),
            new g(n)
        }
        remove(e) {
            return e = Kn(e),
        ...
        nodes() {
            return Mn(this.json).map((e => (delete (e = Object.assign({}, e)).children,
            e)))
        }
        cache() {
            return (e => {
            ...
            Mn(e, ( (e, t) => {
                t.props = ( (e, t) => (Object.keys(t).forEach((n => {
                    if (t[n]instanceof Set) {
                        ...
                        Ln(t[n]) ? e[n] = t[n].concat(e[n] || []) : void 0 === e[n] && (e[n] = t[n])
                }
                )),
                e))(t.props, e.props)
            }
    ...
    const Yn = {
      ...
      , er = function(e) {
        if (Yn.hasOwnProperty(e.id))
            return Yn[e.id];
        if (Yn.hasOwnProperty(e.is))
            return Yn[e.is];
        const t = e._cache.parents.find((e => Yn[e]));
        return Yn[t]
    }
      , tr = function(e) {
      ...
      , nr = function(e, t) {
        return e = function(e, t) {
            return Object.keys(e).forEach((n => {
                ...
                e[n].is && "string" == typeof e[n].is && (t.hasOwnProperty(e[n].is) || e.hasOwnProperty(e[n].is) || (e[e[n].is] = {})),
                e[n].not && "string" == typeof e[n].not && !e.hasOwnProperty(e[n].not) && (t.hasOwnProperty(e[n].not) || e.hasOwnProperty(e[n].not) || (e[e[n].not] = {}))
            }
            )),
            e
        }(e, t),
        Object.keys(e).forEach((t => {
            e[t].children = tr(e[t].children),
            e[t].not = tr(e[t].not)
        }
        )),
        Object.keys(e).forEach((t => {
            ...
            addTags: function(e, t) {
                ...
                const n = function(e) {
                  ...
                  , r = function(e) {
                    const t = {};
                    return e.forEach((e => {
                        const {not: n, also: r, is: o, novel: a} = e.props;
                        let i = e._cache.parents;
                        r && (i = i.concat(r)),
                        t[e.id] = {
                            is: o,
                            not: n,
    ...
    const or = function(e) {
      ...
      , ar = {
        tag: function(e, t="", n) {
            ...
            return !0 === a && console.log(" +  ", e, t || ""),
            or(e) ? e.forEach((e => o.one.setTag(r, e, i, n, t))) : o.one.setTag(r, e, i, n, t),
            this.uncache(),
            this
        },
        ...
        unTag: function(e, t) {
            ...
            return or(e) ? e.forEach((e => r.one.unTag(n, e, i))) : r.one.unTag(n, e, i),
            this.uncache(),
            this
        },
        canBe: function(e) {
            e = e.replace(/^#/, "");
            const t = this.model.one.tagSet
              , n = this.methods.one.canBe
              , r = [];
            this.document.forEach(( (o, a) => {
                o.forEach(( (o, i) => {
                    n(o, e, t) || r.push([a, i, i + 1])
                }
                ))
            }
            ));
    ...
    var lr = {
        ...
        compute: {
            tagRank: function(e) {
                ...
                t.forEach((e => {
                    e.forEach((e => {
                        const t = Array.from(e.tags);
                        e.tagRank = function(e, t) {
                            return e = e.sort(( (e, n) => {
                                if (sr.has(e) || !t.hasOwnProperty(n))
                                    return 1;
                                if (sr.has(n) || !t.hasOwnProperty(e))
                                    return -1;
                                let r = t[e].children || [];
                                const o = r.length;
                                return r = t[n].children || [],
                                o - r.length
                            }
                            )),
                            e
    ...
    const ur = /([.!?\u203D\u2E18\u203C\u2047-\u2049\u3002]+\s)/g
      ...
      , fr = RegExp("[" + Object.keys(pr).join("") + "]", "g")
      , br = RegExp("[" + Object.values(pr).join("") + "]", "g")
      , vr = function(e) {
        if (!e)
            return !1;
        const t = e.match(br);
      ...
      , Ar = function(e, t) {
        ...
        if (1 === n[0].length && /[a-z]/i.test(n[0]))
            return !1;
        if (r.hasOwnProperty(n[0]))
            return !1;
        if (n[1] = n[1].trim().replace(/[.?!]$/, ""),
        o.hasOwnProperty(n[1]))
            return !1;
        if (!0 === /^([a-z\u00C0-\u00FF`"'/]+)[-–—]([a-z0-9\u00C0-\u00FF].*)/i.test(e))
            return !0;
      ...
      , Ir = /(\S+)/;
    let Tr = [".", "?", "!", ":", ";", "-", "–", "—", "--", "...", "(", ")", "[", "]", '"', "'", "`", "«", "»", "*", "•"];
    Tr = Tr.reduce(( (e, t) => (e[t] = !0,
    e)), {});
    const Dr = /\p{Letter}/u
      , Hr = /[\p{Number}\p{Currency_Symbol}]/u
      , Er = /^[a-z]\.([a-z]\.)+/i
      , Gr = /[sn]['’]$/
      , Or = /([A-Z]\.)+[A-Z]?,?$/
      , Fr = /^[A-Z]\.,?$/
      ...
      , Br = function(e) {
        return function(e) {
            return !0 === Or.test(e) || !0 === zr.test(e) || !0 === Fr.test(e) || !0 === Vr.test(e)
        }(e) && (e = e.replace(/\./g, "")),
        e
    }
      , Sr = function(e, t) {
        ...
        let r = e.text || "";
        r = function(e) {
            const t = e = (e = (e = e || "").toLowerCase()).trim();
            return e = (e = (e = e.replace(/[,;.!?]+$/, "")).replace(/\u2026/g, "...")).replace(/\u2013/g, "-"),
            !1 === /^[:;]/.test(e) && (e = (e = (e = e.replace(/\.{3,}$/g, "")).replace(/[",.!:;?)]+$/g, "")).replace(/^['"(]+/g, "")),
            "" === (e = (e = e.replace(/[\u200B-\u200D\uFEFF]/g, "")).trim()) && (e = t),
        ...
        one: {
            ...
            tokenize: {
                splitSentences: function(e, t) {
                    if (e = e || "",
                    !(e = String(e)) || "string" != typeof e || !1 === kr.test(e))
                        return [];
                    const n = function(e) {
                        const t = []
                          , n = e.split(hr);
                        for (let e = 0; e < n.length; e++) {
                            const r = n[e].split(ur);
                            for (let e = 0; e < r.length; e++)
                                r[e + 1] && !0 === cr.test(r[e + 1]) && (r[e] += r[e + 1],
                                r[e + 1] = ""),
                                "" !== r[e] && t.push(r[e])
                        }
                        return t
                    ...
                    if (r = function(e, t) {
                        ...
                        for (let t = 0; t < e.length; t++) {
                            const a = e[t];
                            !e[t + 1] || n(a, r) || mr(a) ? a && a.length > 0 && (o.push(a),
                            e[t] = "") : e[t + 1] = a + (e[t + 1] || "")
                        }
                        return o
                    }(r, t),
                    r = function(e) {
                        const t = [];
                        for (let n = 0; n < e.length; n += 1) {
                            const r = e[n].match(fr);
                            if (null !== r && 1 === r.length) {
                                if (vr(e[n + 1]) && e[n + 1].length < 280) {
                                    e[n] += e[n + 1],
                                    t.push(e[n]),
                                    e[n + 1] = "",
                                    n += 1;
                    ...
                    r = function(e) {
                        const t = [];
                        for (let n = 0; n < e.length; n += 1) {
                            const r = e[n].match(yr);
                            null !== r && 1 === r.length && e[n + 1] && e[n + 1].length < 250 && null !== e[n + 1].match(wr) && 1 === r.length && !yr.test(e[n + 1]) ? (e[n] += e[n + 1],
                            t.push(e[n]),
                            e[n + 1] = "",
                            n += 1) : t.push(e[n])
                        }
                ...
                isSentence: function(e, t) {
                    ...
                    if (!0 === $r.test(e))
                        return !1;
                    if (3 === e.length && Jr.test(e))
                        return !1;
                    if (!0 === Mr.test(e))
                        return !1;
                    const n = e.replace(/[.!?\u203D\u2E18\u203C\u2047-\u2049] *$/, "").split(" ")
                      , r = n[n.length - 1].toLowerCase();
                    return !0 !== t.hasOwnProperty(r) || !0 !== Kr.test(e)
                },
                splitTerms: function(e, t) {
                    let n = []
                      , r = [];
                    if ("number" == typeof (e = e || "") && (e = String(e)),
                    function(e) {
                        return "[object Array]" === Object.prototype.toString.call(e)
                    }(e))
                        return e;
                    ...
                    for (let e = 0; e < o.length; e++)
                        !0 !== Ar(o[e], t) ? r.push(o[e]) : r = r.concat(Cr(o[e]));
                    let a = "";
                    for (let e = 0; e < r.length; e++) {
                        const t = r[e];
                        !0 === jr.test(t) && !1 === Tr.hasOwnProperty(t) && !1 === xr.test(t) ? (n.length > 0 ? (n[n.length - 1] += a,
                        n.push(t)) : n.push(a + t),
                        a = "") : a += t
                    }
                    return a && (0 === n.length && (n[0] = ""),
                    n[n.length - 1] += a),
                    n = function(e) {
                        for (let t = 1; t < e.length - 1; t++)
                            Nr.test(e[t]) && (e[t - 1] += e[t] + e[t + 1],
                            e[t] = null,
                            e[t + 1] = null);
                        return e
                    }(n),
                    n = function(e) {
                        ...
                        for (let r = 0; r < e.length - 1; r += 1)
                            e[r + 1] && t.test(e[r]) && n.test(e[r + 1]) && (e[r] = e[r] + e[r + 1],
                            e[r + 1] = null);
                        return e
                    }(n),
                    n = n.filter((e => e)),
                ...
                splitWhitespace: (e, t) => {
                    const {str: n, pre: r, post: o} = function(e, t) {
                        ...
                        for (let e = 0; e < u; e += 1) {
                            ...
                            if (!0 !== n[e]) {
                                if (("+" === e || "-" === e) && Hr.test(l[1]))
                                    break;
                                if ("'" === e && 3 === e.length && Hr.test(l[1]))
                                    break;
                                if (Dr.test(e) || Hr.test(e))
                                    break;
                                i += l.shift()
                            }
                        }
                        ...
                        for (let e = 0; e < u; e += 1) {
                            ...
                            if (!0 !== r[e]) {
                                if (Dr.test(e) || Hr.test(e))
                                    break;
                                "." === e && !0 === Er.test(a) || "'" === e && !0 === Gr.test(a) || (s = l.pop() + s)
                            }
                        }
                        return "" === (e = l.join("")) && (a = a.replace(/ *$/, (e => (s = e || "",
                        ""))),
                        e = a,
                        i = ""),
                        {
                ...
                fromString: function(e, t) {
                    const {methods: n, model: r} = t
                      , {splitSentences: o, splitTerms: a, splitWhitespace: i} = n.one.tokenize;
                    return e = o(e = e || "", t).map((e => {
                        let n = a(e, r);
                        return n = n.map((e => i(e, r))),
                        n.forEach((e => {
                            Sr(e, t)
                        }
                        )),
    ...
    const qr = {}
      , Ur = {};
    [[["approx", "apt", "bc", "cyn", "eg", "esp", "est", "etc", "ex", "exp", "prob", "pron", "gal", "min", "pseud", "fig", "jd", "lat", "lng", "vol", "fm", "def", "misc", "plz", "ea", "ps", "sec", "pt", "pref", "pl", "pp", "qt", "fr", "sq", "nee", "ss", "tel", "temp", "vet", "ver", "fem", "masc", "eng", "adj", "vb", "rb", "inf", "situ", "vivo", "vitro", "wr"]], [["dl", "ml", "gal", "qt", "pt", "tbl", "tsp", "tbsp", "km", "dm", "cm", "mm", "mi", "td", "hr", "hrs", "kg", "hg", "dg", "cg", "mg", "µg", "lb", "oz", "sq ft", "hz", "mps", "mph", "kmph", "kb", "mb", "tb", "lx", "lm", "fl oz", "yb"], "Unit"], [["ad", "al", "arc", "ba", "bl", "ca", "cca", "col", "corp", "ft", "fy", "ie", "lit", "ma", "md", "pd", "tce"], "Noun"], [["adj", "adm", "adv", "asst", "atty", "bldg", "brig", "capt", "cmdr", "comdr", "cpl", "det", "dr", "esq", "gen", "gov", "hon", "jr", "llb", "lt", "maj", "messrs", "mlle", "mme", "mr", "mrs", "ms", "mstr", "phd", "prof", "pvt", "rep", "reps", "res", "rev", "sen", "sens", "sfc", "sgt", "sir", "sr", "supt", "surg"], "Honorific"], [["jan", "feb", "mar", "apr", "jun", "jul", "aug", "sep", "sept", "oct", "nov", "dec"], "Month"], [["dept", "univ", "assn", "bros", "inc", "ltd", "co"], "Organization"], [["rd", "st", "dist", "mt", "ave", "blvd", "cl", "cres", "hwy", "ariz", "cal", "calif", "colo", "conn", "fla", "fl", "ga", "ida", "ia", "kan", "kans", "minn", "neb", "nebr", "okla", "penna", "penn", "pa", "dak", "tenn", "tex", "ut", "vt", "va", "wis", "wisc", "wy", "wyo", "usafa", "alta", "ont", "que", "sask"], "Place"]].forEach((e => {
        e[0].forEach((t => {
            qr[t] = !0,
            Ur[t] = "Abbreviation",
            void 0 !== e[1] && (Ur[t] = [Ur[t], e[1]])
        }
        ))
    }
    ));
    var Rr = ["anti", "bi", "co", "contra", "de", "extra", "infra", "inter", "intra", "macro", "micro", "mis", "mono", "multi", "peri", "pre", "pro", "proto", "pseudo", "re", "sub", "supra", "trans", "tri", "un", "out", "ex"].reduce(( (e, t) => (e[t] = !0,
    e)), {});
    const Qr = {
        "!": "¡",
        "?": "¿Ɂ",
    ...
    const _r = /\//
      ...
      , Yr = /[0-9]/
      , eo = function(e, t) {
        const n = e.normal || e.text || e.machine
          , r = t.model.one.aliases;
        if (r.hasOwnProperty(n) && (e.alias = e.alias || [],
        e.alias.push(r[n])),
        _r.test(n) && !Xr.test(n) && !Yr.test(n)) {
            const t = n.split(_r);
            t.length <= 3 && t.forEach((t => {
                "" !== (t = t.trim()) && (e.alias = e.alias || [],
                e.alias.push(t))
            }
            ))
        }
      ...
      , oo = {
        ...
        offset: function(e) {
            ...
            for (let e = 0; e < r.length; e += 1)
                for (let o = 0; o < r[e].length; o += 1) {
                    const a = r[e][o];
                    a.offset = {
                        index: n,
                        start: t + a.pre.length,
                        length: a.text.length
                    },
                    t += a.pre.length + a.text.length + a.post.length,
                    n += 1
                }
        },
        index: function(e) {
    ...
    var io = {
        typeahead: function(e) {
            const t = e.model.one.typeahead
              , n = e.docs;
            if (0 === n.length || 0 === Object.keys(t).length)
                return;
            const r = n[n.length - 1] || []
              , o = r[r.length - 1];
            if (!o.post && t.hasOwnProperty(o.normal)) {
                ...
                o.machine = n,
                o.typeahead = !0,
                e.compute.preTagger && e.last().unTag("*").compute(["lexicon", "preTagger"])
            }
        }
    };
    const so = function() {
        ...
        const t = e[e.length - 1] || []
          , n = t[t.length - 1];
        return !0 === n.typeahead && n.machine && (n.text = n.machine,
        n.normal = n.machine),
        this
    }
      , lo = {
    ...
    var uo = {
        typeahead: function(e=[], t={}) {
            const n = this.model();
            var r;
            t = Object.assign({}, lo, t),
            r = e,
            "[object Object]" === Object.prototype.toString.call(r) && (Object.assign(n.one.lexicon, e),
            e = Object.keys(e));
            const o = function(e, t, n) {
                ...
                return e.forEach((e => {
                    ...
                    for (let s = t.min; s < i; s += 1) {
                        ...
                        t.safe && n.model.one.lexicon.hasOwnProperty(i) || (!0 !== a.hasOwnProperty(i) && !0 !== r.hasOwnProperty(i) ? r[i] = e : o.push(i))
                    }
                }
                )),
                r = Object.assign({}, a, r),
            ...
            return Object.keys(o).forEach((e => {
                n.one.typeahead.hasOwnProperty(e) ? delete n.one.typeahead[e] : n.one.typeahead[e] = o[e]
            }
            )),
            this
        }
    ...
    const mo = 36
      , po = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ"
      , fo = po.split("").reduce((function(e, t, n) {
        return e[t] = n,
        e
    }
    ), {});
    ...
    const ko = {
      ...
      , Ao = function(e="", t) {
        ...
        const o = function(e) {
            const t = e[e.length - 1];
            if (!0 === ko.hasOwnProperty(t))
                for (let n = 0; n < ko[t].length; n += 1) {
                    const r = ko[t][n][0];
                    if (!0 === r.test(e))
                        return e.replace(r, ko[t][n][1])
                }
            return null
        }(e);
        return null !== o ? o : Po.test(e) ? e + "es" : e + "s"
    }
      , Co = /\|/
      , No = {
        ...
        const t = function(e) {
            ...
            return Object.keys(t).forEach((function(e) {
                ...
                for (let t = 0; t < r.length; t++) {
                    const o = r[t];
                    !0 === n.hasOwnProperty(o) ? !1 === Array.isArray(n[o]) ? n[o] = [n[o], e] : n[o].push(e) : n[o] = e
                }
            }
            )),
            n
        }(go[e]);
        Co.test(e) ? Object.keys(t).forEach((t => {
            if (jo[t] = e,
            "Noun|Verb" === e) {
                const e = Ao(t, xo);
                jo[e] = "Plural|Verb"
    ...
    [":(", ":)", ":P", ":p", ":O", ";(", ";)", ";P", ";p", ";O", ":3", ":|", ":/", ":\\", ":$", ":*", ":@", ":-(", ":-)", ":-P", ":-p", ":-O", ":-3", ":-|", ":-/", ":-\\", ":-$", ":-*", ":-@", ":^(", ":^)", ":^P", ":^p", ":^O", ":^3", ":^|", ":^/", ":^\\", ":^$", ":^*", ":^@", "):", "(:", "$:", "*:", ")-:", "(-:", "$-:", "*-:", ")^:", "(^:", "$^:", "*^:", "<3", "</3", "<\\3", "=("].forEach((e => No[e] = "Emoticon")),
    delete No[""],
    delete No.null,
    delete No[" "];
    const Io = "Singular";
    ...
    const Eo = {
        beforeTags: Object.assign({}, Ho.beforeTags, To.beforeTags, {}),
        afterTags: Object.assign({}, Ho.afterTags, To.afterTags, {}),
        beforeWords: Object.assign({}, Ho.beforeWords, To.beforeWords, {}),
        afterWords: Object.assign({}, Ho.afterWords, To.afterWords, {})
    }
      , Go = "Adjective";
    var Oo = {
        beforeTags: {
    ...
    const zo = "Gerund"
      , Bo = "Adjective"
      , So = {
        beforeTags: Object.assign({}, Oo.beforeTags, Vo.beforeTags, {
            Imperative: zo,
            Infinitive: Bo,
            Plural: zo
        }),
        afterTags: Object.assign({}, Oo.afterTags, Vo.afterTags, {
            Noun: Bo
        }),
        beforeWords: Object.assign({}, Oo.beforeWords, Vo.beforeWords, {
            is: Bo,
            are: zo,
            was: Bo,
            of: Bo,
        ...
        afterWords: Object.assign({}, Oo.afterWords, Vo.afterWords, {
            to: zo,
            not: zo,
            the: zo
        })
      ...
      , Mo = {
        beforeTags: Object.assign({}, Oo.beforeTags, To.beforeTags, $o.beforeTags),
        afterTags: Object.assign({}, Oo.afterTags, To.afterTags, $o.afterTags),
        beforeWords: Object.assign({}, Oo.beforeWords, To.beforeWords, {
            are: "Adjective",
            is: "Adjective",
            was: "Adjective",
            be: "Adjective",
        ...
        afterWords: Object.assign({}, Oo.afterWords, To.afterWords)
    }
      , Lo = "PastTense"
      , Ko = "Adjective"
      , Jo = {
    ...
    var Wo = {
        beforeTags: Object.assign({}, Oo.beforeTags, Jo.beforeTags),
        afterTags: Object.assign({}, Oo.afterTags, Jo.afterTags),
        beforeWords: Object.assign({}, Oo.beforeWords, Jo.beforeWords),
        afterWords: Object.assign({}, Oo.afterWords, Jo.afterWords)
    };
    const qo = {
        afterTags: {
            Noun: "Adjective",
      ...
      , Uo = {
        beforeTags: Object.assign({}, Oo.beforeTags, Ho.beforeTags, {
            Adverb: void 0,
            Negative: void 0
        }),
        afterTags: Object.assign({}, Oo.afterTags, Ho.afterTags, qo.afterTags),
        beforeWords: Object.assign({}, Oo.beforeWords, Ho.beforeWords, {
            have: void 0,
            had: void 0,
            not: void 0,
            went: "Adjective",
        ...
        afterWords: Object.assign({}, Oo.afterWords, Ho.afterWords, {
            to: void 0,
            as: "Adjective"
        })
    }
      ...
      , Xo = {
        beforeTags: Object.assign({}, Vo.beforeTags, To.beforeTags, Ro),
        afterTags: Object.assign({}, Vo.afterTags, To.afterTags, Qo),
        beforeWords: Object.assign({}, Vo.beforeWords, To.beforeWords, Zo),
        afterWords: Object.assign({}, Vo.afterWords, To.afterWords, _o)
    }
      , Yo = "Singular"
      , ea = "Infinitive"
      , ta = {
    ...
    var ia = {
        beforeTags: Object.assign({}, ra.beforeTags, aa.beforeTags),
        afterTags: Object.assign({}, ra.afterTags, aa.afterTags),
        beforeWords: Object.assign({}, ra.beforeWords, aa.beforeWords),
        afterWords: Object.assign({}, ra.afterWords, aa.afterWords)
    };
    const sa = "Place"
      , la = {
        beforeTags: {
      ...
      , ca = {
        ...
        "Noun|Gerund": Xo,
        "Person|Noun": {
            beforeTags: Object.assign({}, To.beforeTags, ra.beforeTags),
            afterTags: Object.assign({}, To.afterTags, ra.afterTags),
            beforeWords: Object.assign({}, To.beforeWords, ra.beforeWords, {
                i: "Infinitive",
                we: "Infinitive"
            }),
            afterWords: Object.assign({}, To.afterWords, ra.afterWords)
        },
        "Person|Date": ia,
        "Person|Verb": {
            beforeTags: Object.assign({}, To.beforeTags, ra.beforeTags, Ho.beforeTags),
            afterTags: Object.assign({}, To.afterTags, ra.afterTags, Ho.afterTags),
            beforeWords: Object.assign({}, To.beforeWords, ra.beforeWords, Ho.beforeWords),
            afterWords: Object.assign({}, To.afterWords, ra.afterWords, Ho.afterWords)
        },
        "Person|Place": {
            beforeTags: Object.assign({}, la.beforeTags, ra.beforeTags),
            afterTags: Object.assign({}, la.afterTags, ra.afterTags),
            beforeWords: Object.assign({}, la.beforeWords, ra.beforeWords),
            afterWords: Object.assign({}, la.afterWords, ra.afterWords)
        },
        "Person|Adj": {
            beforeTags: Object.assign({}, ra.beforeTags, Oo.beforeTags),
            afterTags: Object.assign({}, ra.afterTags, Oo.afterTags),
            beforeWords: Object.assign({}, ra.beforeWords, Oo.beforeWords),
            afterWords: Object.assign({}, ra.afterWords, Oo.afterWords)
        },
        "Unit|Noun": {
            beforeTags: {
                Value: ua
      ...
      , ha = (e, t) => {
        const n = Object.keys(e).reduce(( (t, n) => (t[n] = "Infinitive" === e[n] ? "PresentTense" : "Plural",
        t)), {});
        return Object.assign(n, t)
    }
    ;
    ca["Plural|Verb"] = {
        beforeWords: ha(ca["Noun|Verb"].beforeWords, {
            had: "Plural",
            have: "Plural"
        }),
        afterWords: ha(ca["Noun|Verb"].afterWords, {
            his: "PresentTense",
            her: "PresentTense",
            its: "PresentTense",
            in: null,
        ...
        beforeTags: ha(ca["Noun|Verb"].beforeTags, {
            Conjunction: "PresentTense",
            Noun: void 0,
            ProperNoun: "PresentTense"
        }),
        afterTags: ha(ca["Noun|Verb"].afterTags, {
            Gerund: "Plural",
            Noun: "PresentTense",
            Value: "PresentTense"
        })
    ...
    const Ha = "Adjective"
      ...
      , Ma = "LastName";
    var La = {
        a: [[/.[aeiou]na$/, $a, "tuna"], [/.[oau][wvl]ska$/, Ma], [/.[^aeiou]ica$/, Oa, "harmonica"], [/^([hyj]a+)+$/, za, "haha"]],
        c: [[/.[^aeiou]ic$/, Ha]],
        d: [[/[aeiou](pp|ll|ss|ff|gg|tt|rr|bb|nn|mm)ed$/, Fa, "popped"], [/.[aeo]{2}[bdgmnprvz]ed$/, Fa, "rammed"], [/.[aeiou][sg]hed$/, Fa, "gushed"], [/.[aeiou]red$/, Fa, "hired"], [/.[aeiou]r?ried$/, Fa, "hurried"], [/[^aeiou]ard$/, Oa, "steward"], [/[aeiou][^aeiou]id$/, Ha, ""], [/.[vrl]id$/, Ha, "livid"], [/..led$/, Fa, "hurled"], [/.[iao]sed$/, Fa, ""], [/[aeiou]n?[cs]ed$/, Fa, ""], [/[aeiou][rl]?[mnf]ed$/, Fa, ""], [/[aeiou][ns]?c?ked$/, Fa, "bunked"], [/[aeiou]gned$/, Fa], [/[aeiou][nl]?ged$/, Fa], [/.[tdbwxyz]ed$/, Fa], [/[^aeiou][aeiou][tvx]ed$/, Fa], [/.[cdflmnprstv]ied$/, Fa, "emptied"]],
        e: [[/.[lnr]ize$/, Ea, "antagonize"], [/.[^aeiou]ise$/, Ea, "antagonise"], [/.[aeiou]te$/, Ea, "bite"], [/.[^aeiou][ai]ble$/, Ha, "fixable"], [/.[^aeiou]eable$/, Ha, "maleable"], [/.[ts]ive$/, Ha, "festive"], [/[a-z]-like$/, Ha, "woman-like"]],
        h: [[/.[^aeiouf]ish$/, Ha, "cornish"], [/.v[iy]ch$/, Ma, "..ovich"], [/^ug?h+$/, za, "ughh"], [/^uh[ -]?oh$/, za, "uhoh"], [/[a-z]-ish$/, Ha, "cartoon-ish"]],
        i: [[/.[oau][wvl]ski$/, Ma, "polish-male"]],
        k: [[/^(k){2}$/, za, "kkkk"]],
        l: [[/.[gl]ial$/, Ha, "familial"], [/.[^aeiou]ful$/, Ha, "fitful"], [/.[nrtumcd]al$/, Ha, "natal"], [/.[^aeiou][ei]al$/, Ha, "familial"]],
        m: [[/.[^aeiou]ium$/, Oa, "magnesium"], [/[^aeiou]ism$/, Oa, "schism"], [/^[hu]m+$/, za, "hmm"], [/^\d+ ?[ap]m$/, "Date", "3am"]],
        n: [[/.[lsrnpb]ian$/, Ha, "republican"], [/[^aeiou]ician$/, Ba, "musician"], [/[aeiou][ktrp]in'$/, "Gerund", "cookin'"]],
        o: [[/^no+$/, za, "noooo"], [/^(yo)+$/, za, "yoo"], [/^wo{2,}[pt]?$/, za, "woop"]],
        r: [[/.[bdfklmst]ler$/, "Noun"], [/[aeiou][pns]er$/, Oa], [/[^i]fer$/, Ea], [/.[^aeiou][ao]pher$/, Ba], [/.[lk]er$/, "Noun"], [/.ier$/, "Comparative"]],
        t: [[/.[di]est$/, "Superlative"], [/.[icldtgrv]ent$/, Ha], [/[aeiou].*ist$/, Ha], [/^[a-z]et$/, Sa]],
        s: [[/.[^aeiou]ises$/, Ga], [/.[rln]ates$/, Ga], [/.[^z]ens$/, Sa], [/.[lstrn]us$/, Oa], [/.[aeiou]sks$/, Ga], [/.[aeiou]kes$/, Ga], [/[aeiou][^aeiou]is$/, Oa], [/[a-z]'s$/, $a], [/^yes+$/, za]],
        v: [[/.[^aeiou][ai][kln]ov$/, Ma]],
        y: [[/.[cts]hy$/, Ha], [/.[st]ty$/, Ha], [/.[tnl]ary$/, Ha], [/.[oe]ry$/, Oa], [/[rdntkbhs]ly$/, Va], [/.(gg|bb|zz)ly$/, Ha], [/...lly$/, Va], [/.[gk]y$/, Ha], [/[bszmp]{2}y$/, Ha], [/.[ai]my$/, Ha], [/[ea]{2}zy$/, Ha], [/.[^aeiou]ity$/, Oa]]
    };
    const Ka = "Verb"
      , Ja = "Noun";
    var Wa = {
        leftTags: [["Adjective", Ja], ["Possessive", Ja], ["Determiner", Ja], ["Adverb", Ka], ["Pronoun", Ka], ["Value", Ja], ["Ordinal", Ja], ["Modal", Ka], ["Superlative", Ja], ["Demonym", Ja], ["Honorific", "Person"]],
        leftWords: [["i", Ka], ["first", Ja], ["it", Ka], ["there", Ka], ["not", Ka], ["because", Ja], ["if", Ja], ["but", Ja], ["who", Ka], ["this", Ja], ["his", Ja], ["when", Ja], ["you", Ka], ["very", "Adjective"], ["old", Ja], ["never", Ka], ["before", Ja], ["a", Ja], ["the", Ja], ["been", Ka]],
        rightTags: [["Copula", Ja], ["PastTense", Ja], ["Conjunction", Ja], ["Modal", Ja]],
        rightWords: [["there", Ka], ["me", Ka], ["man", "Adjective"], ["him", Ka], ["it", Ka], ["were", Ja], ["took", Ja], ["himself", Ka], ["went", Ja], ["who", Ja], ["jr", "Person"]]
    }
      , qa = {
    ...
    const Xa = function(e="", t={}) {
        ...
        n = n || function(e, t, n={}) {
            ...
            for (let r = e.length - 1; r >= 1; r -= 1) {
                let o = e.length - r
                  , a = e.substring(o, e.length);
                if (!0 === t.hasOwnProperty(a))
                    return e.slice(0, o) + t[a];
                if (!0 === n.hasOwnProperty(a))
                    return e.slice(0, o) + n[a]
            }
      ...
      , Ya = function(e) {
        return Object.entries(e).reduce(( (e, t) => (e[t[1]] = t[0],
        e)), {})
    }
      , ei = function(e={}) {
        return {
      ...
      , ni = function(e) {
        ...
        return Object.keys(t).reduce(( (e, n) => (e[n] = function(e="", t="") {
            let n = (t = String(t)).match(ti);
            if (null === n)
                return t;
            let r = Number(n[1]) || 0;
            return e.substring(0, r) + t.replace(ti, "")
        }(n, t[n]),
        e)), {})
    }
      , ri = function(e={}) {
    ...
    const vi = function(e, t) {
        ...
        for (let t = 0; t < bi.length; t++)
            if (!0 === bi[t][0].test(e))
                return e = e.replace(bi[t][0], bi[t][1]);
        return e
    };
    var yi = {
        toPlural: Ao,
    ...
    wi = Object.keys(wi).reduce(( (e, t) => (wi[t].forEach((n => e[n] = t)),
    e)), {});
    const ki = function(e) {
        const t = e.substring(e.length - 3);
        if (!0 === wi.hasOwnProperty(t))
            return wi[t];
        const n = e.substring(e.length - 2);
        if (!0 === wi.hasOwnProperty(n))
            return wi[n];
        return "s" === e.substring(e.length - 1) ? "PresentTense" : null
    }
      , Pi = {
        are: "be",
        were: "be",
      ...
      , Ai = function(e, t, n) {
        const {fromPast: r, fromPresent: o, fromGerund: a, fromParticiple: i} = t.two.models
          , {prefix: s, verb: l, particle: u} = function(e, t) {
            let n = ""
              , r = {};
        ...
        Pi.hasOwnProperty(e))
            c = Pi[e];
        else if ("Participle" === n)
            c = Xa(l, i);
        else if ("PastTense" === n)
            c = Xa(l, r);
        else if ("PresentTense" === n)
            c = Xa(l, o);
        else {
            if ("Gerund" !== n)
                return e;
      ...
      , Ci = function(e, t) {
        ...
        const [i,s] = (e => / /.test(e) ? e.split(/ /) : [e, ""])(e)
          , l = {
            Infinitive: i,
            PastTense: Xa(i, n),
            PresentTense: Xa(i, r),
        ...
        if (u !== e && u !== l.PastTense) {
            const n = t.one.lexicon || {};
            "Participle" !== n[u] && "Adjective" !== n[u] || ("play" === e && (u = "played"),
            l.Participle = u)
        }
    ...
    var Ni = {
        ...
        all: function(e, t) {
            const n = Ci(e, t);
            return delete n.FutureTense,
            Object.values(n).filter((e => e))
        }
    };
    const ji = function(e, t) {
      ...
      , Ii = function(e="", t=[]) {
        ...
        for (let r = n <= 6 ? n - 1 : 6; r >= 1; r -= 1) {
            const o = e.substring(n - r, e.length);
            if (!0 === t[o.length].hasOwnProperty(o)) {
                return e.slice(0, n - r) + t[o.length][o]
            }
        }
        return null
    }
      , Ti = "ically"
      , Di = new Set(["analyt" + Ti, "chem" + Ti, "class" + Ti, "clin" + Ti, "crit" + Ti, "ecolog" + Ti, "electr" + Ti, "empir" + Ti, "frant" + Ti, "grammat" + Ti, "ident" + Ti, "ideolog" + Ti, "log" + Ti, "mag" + Ti, "mathemat" + Ti, "mechan" + Ti, "med" + Ti, "method" + Ti, "method" + Ti, "mus" + Ti, "phys" + Ti, "phys" + Ti, "polit" + Ti, "pract" + Ti, "rad" + Ti, "satir" + Ti, "statist" + Ti, "techn" + Ti, "technolog" + Ti, "theoret" + Ti, "typ" + Ti, "vert" + Ti, "whims" + Ti])
      , Hi = [null, {}, {
        ly: ""
    }, {
        ily: "y",
      ...
      , Ei = new Set(["early", "only", "hourly", "daily", "weekly", "monthly", "yearly", "mostly", "duly", "unduly", "especially", "undoubtedly", "conversely", "namely", "exceedingly", "presumably", "accordingly", "overly", "best", "latter", "little", "long", "low"])
      , Gi = {
        wholly: "whole",
        fully: "full",
        truly: "true",
    ...
    var zi = {
        ...
        fromAdverb: function(e) {
            return e.endsWith("ly") ? Di.has(e) ? e.replace(/ically/, "ical") : Ei.has(e) ? null : Gi.hasOwnProperty(e) ? Gi[e] : Ii(e, Hi) || e : null
        },
      ...
      , Si = {
        Singular: (e, t, n, r) => {
            const o = r.one.lexicon
              , a = n.two.transform.noun.toPlural(e, r);
            o[a] || (t[a] = t[a] || "Plural")
        }
        ,
        Actor: (e, t, n, r) => {
        ...
        Comparable: (e, t, n, r) => {
            const o = r.one.lexicon
              , {toSuperlative: a, toComparative: i} = n.two.transform.adjective
              , s = a(e, r);
            o[s] || (t[s] = t[s] || "Superlative");
            const l = i(e, r);
            o[l] || (t[l] = t[l] || "Comparative"),
            t[e] = "Adjective"
        }
        ,
        Demonym: (e, t, n, r) => {
        ...
        Infinitive: (e, t, n, r) => {
            const o = r.one.lexicon
              , a = n.two.transform.verb.conjugate(e, r);
            Object.entries(a).forEach((e => {
                o[e[1]] || t[e[1]] || "FutureTense" === e[0] || (t[e[1]] = e[0])
            }
            ))
        }
        ,
        PhrasalVerb: (e, t, n, r) => {
            ...
            const a = r.one._multiCache
              , [i,s] = e.split(" ");
            o[i] || (t[i] = t[i] || "Infinitive");
            const l = n.two.transform.verb.conjugate(i, r);
            delete l.FutureTense,
            Object.entries(l).forEach((e => {
                if ("Actor" === e[0] || "" === e[1])
                    return;
                t[e[1]] || o[e[1]] || (t[e[1]] = e[0]),
                a[e[1]] = 2;
                const n = e[1] + " " + s;
    ...
    const $i = {
      ...
      , Mi = new Set(["israelis", "menus", "logos"])
      , Li = ["bus", "mas", "was", "ias", "xas", "vas", "cis", "lis", "nis", "ois", "ris", "sis", "tis", "xis", "aus", "cus", "eus", "fus", "gus", "ius", "lus", "nus", "das", "ous", "pus", "rus", "sus", "tus", "xus", "aos", "igos", "ados", "ogos", "'s", "ss"]
      , Ki = function(e) {
        if (!e || e.length <= 3)
            return !1;
        if (Mi.has(e))
            return !0;
        const t = e[e.length - 1];
        return $i.hasOwnProperty(t) ? $i[t].find((t => e.endsWith(t))) : "s" === t && !Li.find((t => e.endsWith(t)))
    };
    var Ji = {
        two: {
            quickSplit: function(e) {
                ...
                return e.forEach((e => {
                    let r = 0;
                    e.forEach(( (o, a) => {
                        t.test(o.post) && function(e, t) {
                            const n = /^[0-9]+$/
                              , r = e[t];
                            if (!r)
                                return !1;
                            const o = new Set(["may", "april", "august", "jan"]);
                            if ("like" === r.normal || o.has(r.normal))
                                return !1;
                            if (r.tags.has("Place") || r.tags.has("Date"))
                                return !1;
                            if (e[t - 1]) {
                                const n = e[t - 1];
                                if (n.tags.has("Date") || o.has(n.normal))
                                    return !1;
                                if (n.tags.has("Adjective") || r.tags.has("Adjective"))
                                    return !1
                            }
                            const a = r.normal;
                            return 1 !== a.length && 2 !== a.length && 4 !== a.length || !n.test(a)
                        }(e, a + 1) && (n.push(e.slice(r, a + 1)),
                        r = a + 1)
                    }
                    )),
            ...
            expandLexicon: function(e, t) {
                ...
                return Object.keys(e).forEach((t => {
                    ...
                    s.length > 1 && (void 0 === a[s[0]] || s.length > a[s[0]]) && (a[s[0]] = s.length),
                    !0 === Si.hasOwnProperty(i) && Si[i](t, o, n, r),
                    o[t] = o[t] || i
                }
                )),
                delete o[""],
    ...
    const Wi = {
      ...
      , Ui = function(e, t) {
        const n = {
          ...
          , {lex: r, _multi: o} = Ji.two.expandLexicon(e, n);
        return Object.assign(t.one.lexicon, r),
        Object.assign(t.one._multiCache, o),
        t
    }
      , Ri = function(e, t, n) {
        const r = Ci(e, Wi);
      ...
      , Zi = function(e, t) {
        ...
        return Object.keys(e).forEach((o => {
            const a = e[o];
            if (n[o] = qi[a],
            "Noun|Verb" !== a && "Person|Verb" !== a && "Actor|Verb" !== a || Ri(o, r, !1),
            "Adj|Present" === a && (Ri(o, r, !0),
            Qi(o, r, t)),
            "Person|Adj" === a && Qi(o, r, t),
            "Adj|Gerund" === a || "Noun|Gerund" === a) {
                const e = Ai(o, Wi, "Gerund");
                r[e] || (n[e] = "Infinitive")
            }
            if ("Noun|Gerund" !== a && "Adj|Noun" !== a && "Person|Noun" !== a || function(e, t, n) {
                const r = Ao(e, n);
                t[r] = t[r] || "Plural"
            }(o, r, t),
            "Adj|Past" === a) {
                const e = Ai(o, Wi, "PastTense");
                r[e] || (n[e] = "Infinitive")
            }
        }
        )),
    ...
    let _i = {
        ...
        two: {
            ...
            endsWith: La,
            neighbours: Wa,
            regexNormal: [[/^[\w.]+@[\w.]+\.[a-z]{2,3}$/, "Email"], [/^(https?:\/\/|www\.)+\w+\.[a-z]{2,3}/, "Url", "http.."], [/^[a-z0-9./].+\.(com|net|gov|org|ly|edu|info|biz|dev|ru|jp|de|in|uk|br|io|ai)/, "Url", ".com"], [/^[PMCE]ST$/, "Timezone", "EST"], [/^ma?c'[a-z]{3}/, "LastName", "mc'neil"], [/^o'[a-z]{3}/, "LastName", "o'connor"], [/^ma?cd[aeiou][a-z]{3}/, "LastName", "mcdonald"], [/^(lol)+[sz]$/, "Expression", "lol"], [/^wo{2,}a*h?$/, "Expression", "wooah"], [/^(hee?){2,}h?$/, "Expression", "hehe"], [/^(un|de|re)\\-[a-z\u00C0-\u00FF]{2}/, "Verb", "un-vite"], [/^(m|k|cm|km)\/(s|h|hr)$/, "Unit", "5 k/m"], [/^(ug|ng|mg)\/(l|m3|ft3)$/, "Unit", "ug/L"], [/[^:/]\/\p{Letter}/u, "SlashedTerm", "love/hate"]],
            regexText: [[/^#[\p{Number}_]*\p{Letter}/u, "HashTag"], [/^@\w{2,}$/, "AtMention"], [/^([A-Z]\.){2}[A-Z]?/i, ["Acronym", "Noun"], "F.B.I"], [/.{3}[lkmnp]in['‘’‛‵′`´]$/, "Gerund", "chillin'"], [/.{4}s['‘’‛‵′`´]$/, "Possessive", "flanders'"], [/^[\p{Emoji_Presentation}\p{Extended_Pictographic}]/u, "Emoji", "emoji-class"]],
            regexNumbers: [[/^@1?[0-9](am|pm)$/i, "Time", "3pm"], [/^@1?[0-9]:[0-9]{2}(am|pm)?$/i, "Time", "3:30pm"], [/^'[0-9]{2}$/, "Year"], [/^[012]?[0-9](:[0-5][0-9])(:[0-5][0-9])$/, "Time", "3:12:31"], [/^[012]?[0-9](:[0-5][0-9])?(:[0-5][0-9])? ?(am|pm)$/i, "Time", "1:12pm"], [/^[012]?[0-9](:[0-5][0-9])(:[0-5][0-9])? ?(am|pm)?$/i, "Time", "1:12:31pm"], [/^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}/i, "Date", "iso-date"], [/^[0-9]{1,4}-[0-9]{1,2}-[0-9]{1,4}$/, "Date", "iso-dash"], [/^[0-9]{1,4}\/[0-9]{1,2}\/([0-9]{4}|[0-9]{2})$/, "Date", "iso-slash"], [/^[0-9]{1,4}\.[0-9]{1,2}\.[0-9]{1,4}$/, "Date", "iso-dot"], [/^[0-9]{1,4}-[a-z]{2,9}-[0-9]{1,4}$/i, "Date", "12-dec-2019"], [/^utc ?[+-]?[0-9]+$/, "Timezone", "utc-9"], [/^(gmt|utc)[+-][0-9]{1,2}$/i, "Timezone", "gmt-3"], [/^[0-9]{3}-[0-9]{4}$/, "PhoneNumber", "421-0029"], [/^(\+?[0-9][ -])?[0-9]{3}[ -]?[0-9]{3}-[0-9]{4}$/, "PhoneNumber", "1-800-"], [/^[-+]?\p{Currency_Symbol}[-+]?[0-9]+(,[0-9]{3})*(\.[0-9]+)?([kmb]|bn)?\+?$/u, ["Money", "Value"], "$5.30"], [/^[-+]?[0-9]+(,[0-9]{3})*(\.[0-9]+)?\p{Currency_Symbol}\+?$/u, ["Money", "Value"], "5.30£"], [/^[-+]?[$£]?[0-9]([0-9,.])+(usd|eur|jpy|gbp|cad|aud|chf|cny|hkd|nzd|kr|rub)$/i, ["Money", "Value"], "$400usd"], [/^[-+]?[0-9]+(,[0-9]{3})*(\.[0-9]+)?\+?$/, ["Cardinal", "NumericValue"], "5,999"], [/^[-+]?[0-9]+(,[0-9]{3})*(\.[0-9]+)?(st|nd|rd|r?th)$/, ["Ordinal", "NumericValue"], "53rd"], [/^\.[0-9]+\+?$/, ["Cardinal", "NumericValue"], ".73th"], [/^[-+]?[0-9]+(,[0-9]{3})*(\.[0-9]+)?%\+?$/, ["Percent", "Cardinal", "NumericValue"], "-4%"], [/^\.[0-9]+%$/, ["Percent", "Cardinal", "NumericValue"], ".3%"], [/^[0-9]{1,4}\/[0-9]{1,4}(st|nd|rd|th)?s?$/, ["Fraction", "NumericValue"], "2/3rds"], [/^[0-9.]{1,3}[a-z]{0,2}[-–—][0-9]{1,3}[a-z]{0,2}$/, ["Value", "NumberRange"], "3-4"], [/^[0-9]{1,2}(:[0-9][0-9])?(am|pm)? ?[-–—] ?[0-9]{1,2}(:[0-9][0-9])?(am|pm)$/, ["Time", "NumberRange"], "3-4pm"], [/^[0-9.]+([a-z°]{1,4})$/, "NumericValue", "9km"]],
            switches: jo,
            clues: ca,
            uncountable: {},
            orgWords: pi,
    ...
    _i = function(e) {
        return e = function(e, t) {
            return Object.keys(e).forEach((n => {
                "Uncountable" === e[n] && (t.two.uncountable[n] = !0,
                e[n] = "Uncountable")
            }
            )),
            t
        }((e = Ui(e.one.lexicon, e)).one.lexicon, e),
        e = function(e) {
    ...
    const Xi = function(e, t, n, r) {
      ...
      , Yi = /^(under|over|mis|re|un|dis|semi)-?/
      , es = function(e, t, n) {
        const r = n.two.switches
          , o = e[t];
        if (r.hasOwnProperty(o.normal))
            o.switch = r[o.normal];
        else if (Yi.test(o.normal)) {
            const e = o.normal.replace(Yi, "");
            e.length > 3 && r.hasOwnProperty(e) && (o.switch = r[e])
        }
    }
      , ts = function(e, t, n) {
        if (!t || 0 === t.length)
      ...
      , ns = ["Acronym", "Abbreviation", "ProperNoun", "Uncountable", "Possessive", "Pronoun", "Activity", "Honorific", "Month"]
      , rs = function(e, t, n) {
        const r = e[t]
          , o = Array.from(r.tags);
        for (let e = 0; e < o.length; e += 1)
            if (n.one.tagSet[o[e]]) {
                const t = n.one.tagSet[o[e]].parents;
                ts(r, t, ` -inferred by #${o[e]}`)
            }
        !function(e) {
            !e.tags.has("Noun") || e.tags.has("Plural") || e.tags.has("Singular") || ns.find((t => e.tags.has(t))) || (Ki(e.normal) ? ts(e, "Plural", "3-plural-guess") : ts(e, "Singular", "3-singular-guess"))
        }(r),
        function(e) {
            const t = e.tags;
            if (t.has("Verb") && 1 === t.size) {
                const t = ki(e.normal);
                t && ts(e, t, "3-verb-tense-guess")
            }
        }(r)
    }
      , os = /^\p{Lu}[\p{Ll}'’]/u
      , as = /[0-9]/
      , is = ["Date", "Month", "WeekDay", "Unit", "Expression"]
      , ss = /[IVX]/
      , ls = /^[IVXLCDM]{2,}$/
      , us = /^M{0,4}(CM|CD|D?C{0,3})(XC|XL|L?X{0,3})(IX|IV|V?I{0,3})$/
      , cs = {
        li: !0,
        dc: !0,
        md: !0,
      ...
      , hs = function(e, t, n) {
        ...
        const o = r.index[1]
          , a = r.text || "";
        return 0 !== o && !0 === os.test(a) && !1 === as.test(a) ? is.find((e => r.tags.has(e))) || r.pre.match(/["']$/) || "the" === r.normal ? null : (rs(e, t, n),
        r.tags.has("Noun") || r.frozen || r.tags.clear(),
        ts(r, "ProperNoun", "2-titlecase"),
        !0) : a.length >= 2 && ls.test(a) && ss.test(a) && us.test(a) && !cs[r.normal] ? (ts(r, "RomanNumeral", "2-xvii"),
        !0) : null
    }
      , ds = function(e="", t=[]) {
        const n = e.length;
      ...
      , gs = function(e, t, n) {
        const r = e[t];
        if (0 === r.tags.size) {
            let e = ds(r.normal, n.two.suffixPatterns);
            if (null !== e)
                return ts(r, e, "2-suffix"),
                r.confidence = .7,
                !0;
            if (r.implicit && (e = ds(r.implicit, n.two.suffixPatterns),
            null !== e))
                return ts(r, e, "2-implicit-suffix"),
                r.confidence = .7,
                !0
        }
        return null
      ...
      , fs = function(e, t, n, r) {
        const o = r.methods.one.setTag
          , {regexText: a, regexNormal: i, regexNumbers: s, endsWith: l} = n.two
          , u = e[t]
          , c = u.machine || u.normal;
        let h = u.text;
        ms.test(u.post) && !ms.test(u.pre) && (h += u.post.trim());
        let d = ps(h, a) || ps(c, i);
        return !d && /[0-9]/.test(c) && (d = ps(c, s)),
        d || 0 !== u.tags.size || (d = function(e="", t) {
            const n = e[e.length - 1];
        ...
        d ? (o([u], d[1], r, null, `2-regex-'${d[2] || d[0]}'`),
        u.confidence = .6,
        !0) : null
    }
      , bs = function(e, t, n) {
        ...
        if (0 === r.tags.size) {
            ...
            if (null !== e)
                return ts(r, e, "2-prefix"),
                r.confidence = .5,
                !0
        }
        return null
    }
      , vs = new Set(["in", "on", "by", "until", "for", "to", "during", "throughout", "through", "within", "before", "after", "of", "this", "next", "last", "circa", "around", "post", "pre", "budget", "classic", "plan", "may"])
      , ys = function(e) {
        if (!e)
            return !1;
        const t = e.normal || e.implicit;
        return !!vs.has(t) || (!!(e.tags.has("Date") || e.tags.has("Month") || e.tags.has("WeekDay") || e.tags.has("Year")) || !!e.tags.has("ProperNoun"))
    }
      , ws = function(e) {
        ...
        if (n.tags.has("NumericValue") && n.tags.has("Cardinal") && 4 === n.normal.length) {
            ...
            if (r && !isNaN(r) && r > 1400 && r < 2100) {
                const o = e[t - 1]
                  , a = e[t + 1];
                if (ys(o) || ys(a))
                    return ts(n, "Year", "2-tagYear");
                if (r >= 1920 && r < 2025) {
                    if (ws(o) || ws(a))
                        return ts(n, "Year", "2-tagYear-close");
                    if (ks(e[t - 2]) || ks(e[t + 2]))
                        return ts(n, "Year", "2-tagYear-far");
                    if (o && (o.tags.has("Determiner") || o.tags.has("Possessive")) && a && a.tags.has("Noun") && !a.tags.has("Plural"))
                        return ts(n, "Year", "2-tagYear-noun")
                }
            }
        }
        return null
      ...
      , As = function(e, t, n, r) {
        ...
        if (a.tags.has("Verb")) {
            i.find((e => a.tags.has(e))) || o([a], "Infinitive", r, null, "2-verb-type''")
        }
    }
      , Cs = /^[A-Z]('s|,)?$/
      , Ns = /^[A-Z-]+$/
      ...
      , Es = function(e, t, n) {
        ...
        return r.tags.has("RomanNumeral") || r.tags.has("Acronym") || r.frozen ? null : function(e, t) {
            let n = e.text;
            if (!1 === Ns.test(n)) {
                if (!(n.length > 3 && !0 === js.test(n)))
                    return !1;
                n = n.replace(/s$/, "")
            }
            return !(n.length > 5 || Ds.hasOwnProperty(n) || t.one.lexicon.hasOwnProperty(e.normal) || !0 !== xs.test(n) && !0 !== Ts.test(n) && !0 !== Cs.test(n) && !0 !== Is.test(n))
        }(r, n) ? (r.tags.clear(),
        ts(r, ["Acronym", "Noun"], "3-no-period-acronym"),
        !0 === Hs[r.normal] && ts(r, "Place", "3-place-acronym"),
        !0 === js.test(r.text) && ts(r, "Plural", "3-plural-acronym"),
        !0) : !Ds.hasOwnProperty(r.text) && Cs.test(r.text) ? (r.tags.clear(),
        ts(r, ["Acronym", "Noun"], "3-one-letter-acronym"),
        !0) : r.tags.has("Organization") && r.text.length <= 3 ? (ts(r, "Acronym", "3-org-acronym"),
        !0) : r.tags.has("Organization") && Ns.test(r.text) && r.text.length <= 6 ? (ts(r, "Acronym", "3-titlecase-acronym"),
        !0) : null
    }
      , Gs = function(e, t) {
        if (!e)
            return null;
        const n = t.find((t => e.normal === t[0]));
        return n ? n[1] : null
    }
      , Os = function(e, t) {
        if (!e)
            return null;
        const n = t.find((t => e.tags.has(t[0])));
        return n ? n[1] : null
    }
      , Fs = function(e, t, n) {
      ...
      , Vs = function(e, t, n) {
        return !!e && (!e.tags.has("FirstName") && !e.tags.has("Place") && (!!(e.tags.has("ProperNoun") || e.tags.has("Organization") || e.tags.has("Acronym")) || !(n || (r = e.text,
        !/^\p{Lu}[\p{Ll}'’]/u.test(r))) && (0 !== t || e.tags.has("Singular"))));
        var r
    }
      , zs = function(e, t, n, r) {
        const o = n.model.two.orgWords
          , a = n.methods.one.setTag
          , i = e[t];
        if (!0 === o[i.machine || i.normal] && Vs(e[t - 1], t - 1, r)) {
            a([e[t]], "Organization", n, null, "3-[org-word]");
            for (let o = t; o >= 0 && Vs(e[o], o, r); o -= 1)
                a([e[o]], "Organization", n, null, "3-[org-word]")
        }
        return null
    }
      , Bs = /'s$/
      , Ss = new Set(["athletic", "city", "community", "eastern", "federal", "financial", "great", "historic", "historical", "local", "memorial", "municipal", "national", "northern", "provincial", "southern", "state", "western", "spring", "pine", "sunset", "view", "oak", "maple", "spruce", "cedar", "willow"])
      , $s = new Set(["center", "centre", "way", "range", "bar", "bridge", "field", "pit"])
      , Ms = function(e, t, n) {
        if (!e)
            return !1;
        const r = e.tags;
        return !(r.has("Organization") || r.has("Possessive") || Bs.test(e.normal)) && (!(!r.has("ProperNoun") && !r.has("Place")) || !(n || (o = e.text,
        !/^\p{Lu}[\p{Ll}'’]/u.test(o))) && (0 !== t || r.has("Singular")));
        var o
    }
      , Ls = function(e, t, n, r) {
        const o = n.model.two.placeWords
          , a = n.methods.one.setTag
          , i = e[t]
          , s = i.machine || i.normal;
        if (!0 === o[s]) {
            for (let o = t - 1; o >= 0; o -= 1)
                if (!Ss.has(e[o].normal)) {
                    if (!Ms(e[o], o, r))
                        break;
                    a(e.slice(o, t + 1), "Place", n, null, "3-[place-of-foo]")
                }
            if ($s.has(s))
                return !1;
            for (let o = t + 1; o < e.length; o += 1) {
                if (Ms(e[o], o, r))
                    return a(e.slice(t, o + 1), "Place", n, null, "3-[foo-place]"),
                    !0;
                if ("of" !== e[o].normal && !Ss.has(e[o].normal))
                    break
            }
        }
        return null
      ...
      , Ks = function(e, t, n) {
        let r = !1;
        const o = e[t].tags;
        (0 === o.size || 1 === o.size && (o.has("Hyphenated") || o.has("HashTag") || o.has("Prefix") || o.has("SlashedTerm"))) && (r = !0),
        r && (ts(e[t], "Noun", "3-[fallback]"),
        rs(e, t, n),
        e[t].confidence = .1)
    }
      , Js = /^[A-Z][a-z]/
      , Ws = (e, t) => e[t].tags.has("ProperNoun") && Js.test(e[t].text) ? "Noun" : null
      , qs = (e, t, n) => 0 !== t || e[1] ? null : n
      , Us = {
        "Adj|Gerund": (e, t) => Ws(e, t),
        "Adj|Noun": (e, t) => Ws(e, t) || function(e, t) {
            return !e[t + 1] && e[t - 1] && e[t - 1].tags.has("Determiner") ? "Noun" : null
        }(e, t),
        "Actor|Verb": (e, t) => Ws(e, t),
        "Adj|Past": (e, t) => Ws(e, t),
        "Adj|Present": (e, t) => Ws(e, t),
        "Noun|Gerund": (e, t) => Ws(e, t),
        "Noun|Verb": (e, t) => t > 0 && Ws(e, t) || qs(e, t, "Infinitive"),
        "Plural|Verb": (e, t) => Ws(e, t) || qs(e, t, "PresentTense") || function(e, t, n) {
            return 0 === t && e.length > 3 ? n : null
        }(e, t, "Plural"),
        "Person|Noun": (e, t) => Ws(e, t),
        "Person|Verb": (e, t) => 0 !== t ? Ws(e, t) : null,
        "Person|Adj": (e, t) => 0 === t && e.length > 1 || Ws(e, t) ? "Person" : null
    }
      , Rs = "undefined" != typeof process && process.env ? process.env : self.env || {}
      , Qs = /^(under|over|mis|re|un|dis|semi)-?/
      , Zs = (e, t) => {
        if (!e || !t)
            return null;
        const n = e.normal || e.implicit;
        let r = null;
        return t.hasOwnProperty(n) && (r = t[n]),
        r && Rs.DEBUG_TAGS && console.log(`\n  [2m[3m     ↓ - '${n}' [0m`),
        r
    }
      , _s = (e, t={}, n) => {
        if (!e || !t)
            return null;
        const r = Array.from(e.tags).sort(( (e, t) => (n[e] ? n[e].parents.length : 0) > (n[t] ? n[t].parents.length : 0) ? -1 : 1));
        let o = r.find((e => t[e]));
        return o && Rs.DEBUG_TAGS && console.log(`  [2m[3m      ↓ - '${e.normal || e.implicit}' (#${o})  [0m`),
        o = t[o],
        o
    }
      , Xs = function(e, t, n) {
        const r = n.model
          ...
          , {switches: a, clues: i} = r.two
          , s = e[t];
        let l = s.normal || s.implicit || "";
        if (Qs.test(l) && !a[l] && (l = l.replace(Qs, "")),
        s.switch) {
            const a = s.switch;
            ...
            let u = function(e, t, n, r) {
                if (!n)
                    return null;
                const o = "also" !== e[t - 1]?.text ? t - 1 : Math.max(0, t - 2)
                  , a = r.one.tagSet;
                let i = Zs(e[t + 1], n.afterWords);
                return i = i || Zs(e[o], n.beforeWords),
                i = i || _s(e[o], n.beforeTags, a),
                i = i || _s(e[t + 1], n.afterTags, a),
                i
            }(e, t, i[a], r);
            Us[a] && (u = Us[a](e, t) || u),
            u ? (o([s], u, n, null, `3-[switch] (${a})`),
            rs(e, t, r)) : Rs.DEBUG_TAGS && console.log(`\n -> X  - '${l}'  : (${a})  `)
        }
    }
      , Ys = {
        there: !0,
      ...
      , el = function(e) {
        if (e.filter((e => !e.tags.has("ProperNoun"))).length <= 3)
            return !1;
        const t = /^[a-z]/;
      ...
      , nl = function(e, t, n, r) {
        ...
        !function(e, t) {
            const n = t.methods.one.setTag
              ...
              , o = e[0];
            if (("Noun|Verb" === o.switch || o.tags.has("Infinitive")) && e.length >= 2) {
                if (e.length < 4 && !Ys[e[1].normal])
                    return;
                if (!o.tags.has("PhrasalVerb") && r.hasOwnProperty(o.normal))
                    return;
                (e[1].tags.has("Noun") || e[1].tags.has("Determiner")) && (e.slice(1, 3).some((e => e.tags.has("Verb"))) && !o.tags.has("#PhrasalVerb") || n([o], "Imperative", t, null, "3-[imperative]"))
            }
        }(e, n)
    }
      , rl = {
                ...
                e.forEach((e => {
                    !function(e, t, n, r) {
                        ...
                        if (e.length >= 3) {
                            ...
                            if (e[0].post.match(t)) {
                                const t = e[1];
                                if (t.tags.has("Value") || t.tags.has("Email") || t.tags.has("PhoneNumber"))
                                    return;
    ...
    const il = ["Person", "Place", "Organization"];
    var sl = {
        Noun: {
    ...
    const hl = /[,)"';:\-–—.…]/
      ...
      , fl = /'/
      , bl = new Set(["been", "become"])
      , vl = new Set(["what", "how", "when", "if", "too"])
      , yl = new Set(["too", "also", "enough"])
      , wl = function(e, t) {
        const n = e[t].normal.split(fl)[0];
        if ("let" === n)
            return [n, "us"];
        if ("there" === n) {
            const r = e[t + 1];
        ...
        return "has" === ( (e, t) => {
            for (let n = t + 1; n < e.length; n += 1) {
                ...
                if ("Adj|Past" === t.switch && e[n + 1]) {
                    if (yl.has(e[n + 1].normal))
                        return "is";
                    if (e[n + 1].tags.has("Preposition"))
                        return "is"
                }
      ...
      , xl = new Set(["too", "also", "enough", "about"])
      , Il = new Set(["is", "are", "did", "were", "could", "should", "must", "had", "have"])
      , Tl = /'/
      , Dl = function(e, t, n, r) {
        const o = t.update();
        o.document = [e];
        ...
        e[a] && (a += 1),
        o.ptrs = [[0, n, a]],
        o.compute(["freeze", "lexicon", "preTagger", "unfreeze"]),
        function(e) {
            e.forEach(( (e, t) => {
                e.index && (e.index[1] = t)
            }
      ...
      , Hl = {
        ...
        s: (e, t, n) => ( (e, t) => {
            const n = e[t];
            if (Nl.hasOwnProperty(n.machine || n.normal))
                return !1;
            if (n.tags.has("Possessive"))
                return !0;
            if (n.tags.has("QuestionWord"))
                return !1;
            if ("he's" === n.normal || "she's" === n.normal)
                return !1;
            const r = e[t + 1];
            if (!r)
                return !0;
            ...
            if ("Noun|Gerund" == r.switch) {
                const r = e[t + 2];
                return r ? !!r.tags.has("Copula") || ("on" === r.normal || r.normal,
                !1) : !(!n.tags.has("Actor") && !n.tags.has("ProperNoun"))
            }
            if (r.tags.has("Verb"))
                return !!r.tags.has("Infinitive") || !r.tags.has("Gerund") && !!r.tags.has("PresentTense");
        ...
        )(e, t) ? n.methods.one.setTag([e[t]], "Possessive", n, null, "2-contraction") : wl(e, t)
    }
      , El = function(e, t) {
        const n = t.fromText(e.join(" "));
        return n.compute("id"),
            ...
            n.forEach(( (r, o) => {
                for (let a = r.length - 1; a >= 0; a -= 1) {
                    if (r[a].implicit)
                        continue;
                    let i = null;
                    !0 === Tl.test(r[a].normal) && (i = r[a].normal.split(Tl)[1]);
                    let s = null;
                    Hl.hasOwnProperty(i) && (s = Hl[i](r, a, t)),
                    s && (s = El(s, e),
                    pl(n, [o, a], s),
                    Dl(n[o], e, a, s.length))
                }
      ...
      , Ol = {
        ...
        api: function(e) {
            ...
            e.prototype.contractions = function() {
                const e = this.match("@hasContraction+");
                return new Contractions(this.document,e.pointer)
            }
            ,
            e.prototype.contract = gl
        },
        hooks: ["contractionTwo"]
    };
    const Fl = "(hard|fast|late|early|high|right|deep|close|direct)";
    const Vl = "(i|we|they)";
    const zl = [].concat([{
    ...
    var Sl = {
        postTagger: function(e) {
            const {world: t} = e
              , {model: n, methods: r} = t;
            Bl = Bl || r.one.buildNet(n.two.matches, t);
            const o = r.two.quickSplit(e.document).map((e => {
                const t = e[0];
    ...
    var Ll = {
        lib: {
            lazy: function(e, t) {
                ...
                const r = this.tokenize(e)
                  , o = Ml(r, n);
                return o.found ? (o.compute(["index", "tagger"]),
                o.match(t)) : r.none()
            }
        }
    };
    const Kl = function(e, t, n) {
        ...
        let o = this.match(r);
        return n && (o = o.if(n)),
        o.has("#Verb") ? function(e, t) {
            let n = t;
            return e.forEach((e => {
                e.has("#Infinitive") || (n = function(e, t) {
                    const n = (0,
                    e.methods.two.transform.verb.conjugate)(t, e.model);
            ...
            e
        }(o, t) : o.has("#Noun") ? function(e, t) {
            let n = t;
            e.has("#Plural") && (n = (0,
            e.methods.two.transform.noun.toPlural)(t, e.model));
            e.replaceWith(n, {
                possessives: !0
            })
        }(o, t) : o.has("#Adverb") ? function(e, t) {
            const {toAdverb: n} = e.methods.two.transform.adjective
              , r = n(t);
            r && e.replaceWith(r)
        }(o, t) : o.has("#Adjective") ? function(e, t) {
            const {toComparative: n, toSuperlative: r} = e.methods.two.transform.adjective;
            let o = t;
            e.has("#Comparative") ? o = n(o, e.model) : e.has("#Superlative") && (o = r(o, e.model)),
            o && e.replaceWith(o)
        }(o, t) : this
    };
    var Jl = {
    ...
    var ql = {
        api: function(e) {
            class Adjectives extends e {
                ...
                json(e={}) {
                    const {toAdverb: t, toNoun: n, toSuperlative: r, toComparative: o} = this.methods.two.transform.adjective;
                    return e.normal = !0,
                    this.map((a => {
                        const i = a.toView().json(e)[0] || {}
                          , s = Wl(a);
                        return i.adjective = {
                            adverb: t(s, this.model),
                            noun: n(s, this.model),
                            superlative: r(s, this.model),
                            comparative: o(s, this.model)
                        },
                        i
                    }
                    ), [])
                ...
                conjugate(e) {
                    const {toComparative: t, toSuperlative: n, toNoun: r, toAdverb: o} = this.methods.two.transform.adjective;
                    return this.getNth(e).map((e => {
                        const a = Wl(e);
                        return {
                            Adjective: a,
                            Comparative: t(a, this.model),
                            Superlative: n(a, this.model),
                            Noun: r(a, this.model),
                            Adverb: o(a, this.model)
                        }
                    }
                    ), [])
                }
            ...
            e.prototype.adjectives = function(e) {
                ...
                return t = t.getNth(e),
                new Adjectives(t.document,t.pointer)
            }
            ,
    ...
    const Rl = function(e) {
        ...
        t = function(e) {
            let t = e.parentheses();
            return t = t.filter((e => e.wordCount() >= 3 && e.has("#Verb") && e.has("#Noun"))),
            e.splitOn(t)
        }(t),
        t = function(e) {
            let t = e.quotations();
        ...
        t = function(e) {
            ...
            return t = t.filter((e => {
                if (1 === e.growLeft(".").wordCount())
                    return !1;
                if (1 === e.growRight(". .").wordCount())
                    return !1;
                let t = e.grow(".");
                return t = t.ifNo("@hasComma @hasComma"),
        ...
        chunks: function(e) {
            ...
            !function(e) {
                for (let t = 0; t < e.length; t += 1)
                    for (let n = 0; n < e[t].length; n += 1) {
                        const r = e[t][n];
                        !0 !== Ql.hasOwnProperty(r.normal) ? r.tags.has("Verb") ? r.chunk = "Verb" : r.tags.has("Noun") || r.tags.has("Determiner") || r.tags.has("Value") ? r.chunk = "Noun" : r.tags.has("QuestionWord") && (r.chunk = "Pivot") : r.chunk = Ql[r.normal]
                    }
            }(t),
            function(e) {
                for (let t = 0; t < e.length; t += 1)
            ...
            function(e) {
                for (let t = 0; t < e.length; t += 1)
                    for (let n = 0; n < e[t].length; n += 1) {
                        const r = e[t][n];
                        void 0 === r.chunk && (r.tags.has("Conjunction") || r.tags.has("Preposition") ? Xl(r, "Pivot") : r.tags.has("Adverb") ? Xl(r, "Verb") : r.chunk = "Noun")
                    }
            }(t),
            function(e) {
                const t = [];
                ...
                e.forEach((e => {
                    for (let r = 0; r < e.length; r += 1) {
                        const o = e[r];
                        n && o.chunk === n ? t[t.length - 1].terms.push(o) : (t.push({
                            chunk: o.chunk,
                            terms: [o]
                        }),
                        n = o.chunk)
      ...
      , eu = {
        ...
        api: function(e) {
            class Chunks extends e {
                ...
                debug() {
                    return this.toView().debug("chunks"),
                    this
                }
                update(e) {
                    const t = new Chunks(this.document,e);
                    return t._cache = this._cache,
                    t
                }
            }
            e.prototype.chunks = function(e) {
                let t = function(e) {
                    ...
                    return e.clauses().docs.forEach((e => {
                        e.forEach((e => {
                            e.chunk && e.chunk === n ? t[t.length - 1][2] = e.index[1] + 1 : (n = e.chunk,
                ...
                return t = t.getNth(e),
                new Chunks(this.document,t.pointer)
            }
            ,
            e.prototype.clauses = Rl
        },
        hooks: ["chunks"]
    };
    const tu = /\./g
      ...
      , au = function(e) {
        class Parentheses extends e {
            ...
            strip() {
                return function(e) {
                    return e.docs.forEach((e => {
                        e[0].pre = e[0].pre.replace(nu, "");
                        const t = e[e.length - 1];
                        t.post = t.post.replace(ru, "")
                    }
                    )),
                    e
                }(this)
        ...
        e.prototype.parentheses = function(e) {
            let t = function(e) {
                ...
                return e.docs.forEach((e => {
                    for (let n = 0; n < e.length; n += 1) {
                        const r = e[n];
                        if (r.pre && nu.test(r.pre)) {
                            const r = ou(e, n);
                            if (null !== r) {
                                const [o,a] = e[n].index;
                                t.push([o, a, r + 1, e[n].id]),
                                n = r
                            }
                        }
                    }
      ...
      , lu = RegExp("[" + Object.keys(su).join("") + "]")
      , uu = RegExp("[" + Object.values(su).join("") + "]")
      , cu = function(e, t) {
        const n = e[t].pre.match(lu)[0] || "";
        if (!n || !su[n])
            return null;
        const r = su[n];
        for (; t < e.length; t += 1)
      ...
      , hu = function(e) {
        class Quotations extends e {
            ...
            strip() {
                return function(e) {
                    e.docs.forEach((e => {
                        e[0].pre = e[0].pre.replace(lu, "");
                        const t = e[e.length - 1];
                        t.post = t.post.replace(uu, "")
                    }
                    ))
                }(this)
            }
      ...
      , gu = [["hyphenated", "@hasHyphen ."], ["hashTags", "#HashTag"], ["emails", "#Email"], ["emoji", "#Emoji"], ["emoticons", "#Emoticon"], ["atMentions", "#AtMention"], ["urls", "#Url"], ["conjunctions", "#Conjunction"], ["prepositions", "#Preposition"], ["abbreviations", "#Abbreviation"], ["honorifics", "#Honorific"]]
      , mu = [["emojis", "emoji"], ["atmentions", "atMentions"]]
      , pu = /\//;
    var fu = {
        api: function(e) {
            !function(e) {
                class Acronyms extends e {
                    ...
                    strip() {
                        return this.docs.forEach((e => {
                            e.forEach((e => {
                                e.text = e.text.replace(tu, ""),
                                e.normal = e.normal.replace(tu, "")
                            }
                            ))
                        }
                        )),
            ...
            function(e) {
                class Possessives extends e {
                    ...
                    strip() {
                        return this.docs.forEach((e => {
                            e.forEach((e => {
                                e.text = e.text.replace(iu, ""),
                                e.normal = e.normal.replace(iu, "")
                            }
                            ))
                        }
                        )),
                ...
                e.prototype.possessives = function(e) {
                    let t = function(e) {
                        ...
                        return t.has("#Person") && (t = t.growLeft("#Person+")),
            ...
            function(e) {
                gu.forEach((t => {
                    e.prototype[t[0]] = function(e) {
                        const n = this.match(t[1]);
                        return "number" == typeof e ? n.get(e) : n
                    }
                }
                )),
                e.prototype.phoneNumbers = du,
                mu.forEach((t => {
            ...
            function(e) {
                class Slashes extends e {
                    ...
                    split() {
                        return this.map((e => {
                            const t = e.text().split(pu);
                            return (e = e.replaceWith(t.join(" "))).growRight("(" + t.join("|") + ")+")
                        }
                        ))
                    }
                }
                e.prototype.slashes = function(e) {
                    ...
                    return t = t.getNth(e),
                    new Slashes(t.document,t.pointer)
                }
            }(e)
        }
    };
    ...
    const yu = e => e.split("|").reduce(( (e, t) => (e[t] = !0,
    e)), {})
      , wu = "unicode|punctuation|whitespace|acronyms"
      , ku = "|case|contractions|parentheses|quotations|emoji|honorifics|debullet"
      , Pu = {
        light: yu(wu),
        medium: yu(wu + ku),
        heavy: yu(wu + ku + "|possessives|adverbs|nouns|verbs")
    };
    var Au = {
        api: function(e) {
            e.prototype.normalize = function(e="light") {
                return "string" == typeof e && (e = Pu[e]),
                Object.keys(e).forEach((t => {
                    vu.hasOwnProperty(t) && vu[t](this, e[t])
                }
                )),
                this
            }
    ...
    const Cu = ["after", "although", "as if", "as long as", "as", "because", "before", "even if", "even though", "ever since", "if", "in order that", "provided that", "since", "so that", "than", "that", "though", "unless", "until", "what", "whatever", "when", "whenever", "where", "whereas", "wherever", "whether", "which", "whichever", "who", "whoever", "whom", "whomever", "whose"]
      , Nu = function(e) {
        if (e.before("#Preposition$").found)
            return !0;
        if (!e.before().found)
            return !1;
        for (let t = 0; t < Cu.length; t += 1)
            if (e.has(Cu[t]))
                return !0;
        return !1
    }
      , ju = function(e, t) {
        if (e.has("#Plural"))
            return !0;
        if (e.has("#Noun and #Noun"))
            return !0;
        if (e.has("(we|they)"))
            return !0;
        if (!0 === t.has("(#Pronoun|#Place|#Value|#Person|#Uncountable|#Month|#WeekDay|#Holiday|#Possessive)"))
            return !1;
        if (e.has("#Singular"))
            return !1;
    ...
    var Ou = {
        api: function(e) {
            class Nouns extends e {
                ...
                parse(e) {
                    return this.getNth(e).map(xu)
                }
                json(e) {
                    const t = "object" == typeof e ? e : {};
                    return this.getNth(e).map((e => {
                        const n = e.toView().json(t)[0] || {};
                        return t && !1 !== t.noun && (n.noun = function(e) {
                            const t = xu(e);
                            return {
                                root: Iu(t.root),
                                number: Du(t.number),
                                determiner: Iu(t.determiner),
                                adjectives: Tu(t.adjectives),
                                isPlural: t.isPlural,
                ...
                conjugate(e) {
                    ...
                    return this.getNth(e).map((e => {
                        ...
                        return Hu(n.root) && (o.Plural = t.toPlural(r, this.model)),
                        o.Singular === o.Plural && delete o.Plural,
                        o
                    }
                    ), [])
                }
                isPlural(e) {
                    const t = this.filter((e => xu(e).isPlural));
                    return t.getNth(e)
                }
                isSingular(e) {
                    const t = this.filter((e => !xu(e).isPlural));
                ...
                toPlural(e) {
                    return this.getNth(e).map((e => function(e, t) {
                        if (!0 === t.isPlural)
                            return e;
                        if (t.root.has("#Possessive") && (t.root = t.root.possessives().strip()),
                        !Hu(t.root))
                            return e;
                        const {methods: n, model: r} = e.world
                          , {toPlural: o} = n.two.transform.noun
                          , a = o(t.root.text({
                            keepPunct: !1
                        }), r);
                        e.match(t.root).replaceWith(a, Eu).tag("Plural", "toPlural"),
                        t.determiner.has("(a|an)") && e.remove(t.determiner);
                        const i = t.root.after("not? #Adverb+? [#Copula]", 0);
                        return i.found && (i.has("is") ? e.replace(i, "are") : i.has("was") && e.replace(i, "were")),
                        e
                    }(e, xu(e))))
                }
                toSingular(e) {
                    return this.getNth(e).map((e => function(e, t) {
                        if (!1 === t.isPlural)
                            return e;
                        const {methods: n, model: r} = e.world
                          , {toSingular: o} = n.two.transform.noun
                          , a = o(t.root.text("normal"), r);
                        return e.replace(t.root, a, Gu).tag("Singular", "toPlural"),
                        e
                    }(e, xu(e))))
                }
                update(e) {
                    const t = new Nouns(this.document,e);
                    return t._cache = this._cache,
                    t
                }
            }
            e.prototype.nouns = function(e) {
                ...
                return t = t.getNth(e),
                new Nouns(this.document,t.pointer)
            }
        }
    };
    var Fu = {
    ...
    const Vu = (e, t) => {
        if (Fu.ones.hasOwnProperty(e)) {
            if (t.ones || t.teens)
                return !1
        } else if (Fu.teens.hasOwnProperty(e)) {
            if (t.ones || t.teens || t.tens)
                return !1
        } else if (Fu.tens.hasOwnProperty(e) && (t.ones || t.teens || t.tens))
            return !1;
        return !0
    }
      , zu = function(e) {
        ...
        for (let n = 0; n < e.length; n++) {
            const r = e[n];
            if (!0 === Fu.ones.hasOwnProperty(r))
                t += Fu.ones[r];
            else if (!0 === Fu.teens.hasOwnProperty(r))
                t += Fu.teens[r];
            else if (!0 === Fu.tens.hasOwnProperty(r))
                t += Fu.tens[r];
            else {
                if (!0 !== /^[0-9]$/.test(r))
                    return 0;
      ...
      , Bu = e => e = (e = (e = (e = (e = (e = (e = (e = e.replace(/1st$/, "1")).replace(/2nd$/, "2")).replace(/3rd$/, "3")).replace(/([4567890])r?th$/, "$1")).replace(/^[$€¥£¢]/, "")).replace(/[%$€¥£¢]$/, "")).replace(/,/g, "")).replace(/([0-9])([a-z\u00C0-\u00FF]{1,2})$/, "$1")
      , Su = /^([0-9,. ]+)\/([0-9,. ]+)$/
      , $u = {
        "a few": 3,
        "a couple": 2,
      ...
      , Lu = function(e) {
        ...
        for (let e = 0; e < i.length; e++) {
            ...
            if (l) {
                ...
                if (Fu.tens.hasOwnProperty(s) && r.ones && 1 === Object.keys(r).length && (o = 100 * r.ones,
                r = {}),
                !1 === Vu(s, r))
                    return null;
                if (/^[0-9.]+$/.test(s))
                    r.ones = parseFloat(s);
                else if (!0 === Fu.ones.hasOwnProperty(s))
                    r.ones = Fu.ones[s];
                else if (!0 === Fu.teens.hasOwnProperty(s))
                    r.teens = Fu.teens[s];
                else if (!0 === Fu.tens.hasOwnProperty(s))
                    r.tens = Fu.tens[s];
                else if (!0 === Fu.multiples.hasOwnProperty(s)) {
                    let t = Fu.multiples[s];
                    if (t === n)
                        return null;
                    if (100 === t && void 0 !== i[e + 1]) {
                        const n = i[e + 1];
                        Fu.multiples[n] && (t *= Fu.multiples[n],
                        e += 1)
                    }
                    null === n || t < n ? (o += (Mu(r) || 1) * t,
                    n = t,
                    r = {}) : (o += Mu(r),
                    n = t,
                    o = (o || 1) * t,
        ...
        o *= t.amount,
        o *= a ? -1 : 1,
        0 === o && 0 === Object.keys(r).length ? null : o
    }
      , Ku = /s$/
      , Ju = function(e) {
      ...
      , qu = function(e) {
        const t = function(e) {
            const t = e.text("reduced");
            return Wu.hasOwnProperty(t) ? {
                numerator: 1,
                denominator: Wu[t]
            } : null
        }(e = e.clone()) || function(e) {
            const t = e.text("reduced").match(/^([-+]?[0-9]+)\/([-+]?[0-9]+)(st|nd|rd|th)?s?$/);
            return t && t[1] && t[0] ? {
            ...
            return Ku.test(o) && (o = o.replace(Ku, ""),
            r = r.replaceWith(o)),
            r = Wu.hasOwnProperty(o) ? Wu[o] : Ju(r),
        ...
        return null !== t && t.numerator && t.denominator && (t.decimal = t.numerator / t.denominator,
        t.decimal = (e => {
      ...
      , Uu = function(e) {
        if (e < 1e6)
            return String(e);
        let t;
        return t = "number" == typeof e ? e.toFixed(0) : e,
        -1 === t.indexOf("e+") ? t : t.replace(".", "").split("e+").reduce((function(e, t) {
            return e + Array(t - e.length + 2).join(0)
        }
        ))
    }
      , Ru = [["ninety", 90], ["eighty", 80], ["seventy", 70], ["sixty", 60], ["fifty", 50], ["forty", 40], ["thirty", 30], ["twenty", 20]]
      , Qu = ["", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"]
      , Zu = [[1e24, "septillion"], [1e20, "hundred sextillion"], [1e21, "sextillion"], [1e20, "hundred quintillion"], [1e18, "quintillion"], [1e17, "hundred quadrillion"], [1e15, "quadrillion"], [1e14, "hundred trillion"], [1e12, "trillion"], [1e11, "hundred billion"], [1e9, "billion"], [1e8, "hundred million"], [1e6, "million"], [1e5, "hundred thousand"], [1e3, "thousand"], [100, "hundred"], [1, "one"]]
      , _u = function(e) {
        const t = [];
        if (e > 100)
            return t;
      ...
      , Xu = function(e) {
        ...
        for (let e = 0; e < r.length; e++) {
            let t = r[e].unit;
            "one" === t && (t = "",
            n.length > 1 && n.push("and")),
            n = n.concat(_u(r[e].count)),
            n.push(t)
        }
        return n = n.concat((e => {
      ...
      , ec = e => {
        const t = Xu(e).split(" ")
          , n = t[t.length - 1];
        return Yu.hasOwnProperty(n) ? t[t.length - 1] = Yu[n] : t[t.length - 1] = n.replace(/y$/, "i") + "th",
        t.join(" ")
    }
      , tc = function(e) {
        class Fractions extends e {
            ...
            toFraction(e) {
                return this.getNth(e).forEach((e => {
                    ...
                    if (t && "number" == typeof t.numerator && "number" == typeof t.denominator) {
                        const n = `${t.numerator}/${t.denominator}`;
                        this.replace(e, n)
                    }
                }
                )),
            ...
            toOrdinal(e) {
                return this.getNth(e).forEach((e => {
                    let t = function(e) {
                        ...
                        return 2 === e.denominator && (n = "half"),
                        t && n ? (1 !== e.numerator && (n += "s"),
                        `${t} ${n}`) : ""
                    }(qu(e));
                    e.after("^#Noun").found && (t += " of"),
                    e.replaceWith(t)
                }
                )),
                this
            ...
            toCardinal(e) {
                return this.getNth(e).forEach((e => {
                    const t = function(e) {
                        return e.numerator && e.denominator ? `${Xu({
                            num: e.numerator
                        })} out of ${Xu({
                            num: e.denominator
                        })}` : ""
        ...
        e.prototype.fractions = function(e) {
            let t = function(e, t) {
                ...
                return n = n.filter((e => !e.lookBehind("#Value and$").found)),
                n = n.notIf("#Value seconds"),
                n
            }(this);
            return t = t.getNth(e),
            new Fractions(this.document,t.pointer)
        }
    }
      , nc = "twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety|fourty"
      , rc = function(e) {
        let t = e.match("#Value+");
        if (t.has("#NumericValue #NumericValue") && (t.has("#Value @hasComma #Value") ? t.splitAfter("@hasComma") : t.has("#NumericValue #Fraction") ? t.splitAfter("#NumericValue #Fraction") : t = t.splitAfter("#NumericValue")),
        t.has("#Value #Value #Value") && !t.has("#Multiple") && t.has("(" + nc + ") #Cardinal #Cardinal") && (t = t.splitAfter("(" + nc + ") #Cardinal")),
        t.has("#Value #Value")) {
            t.has("#NumericValue #NumericValue") && (t = t.splitOn("#Year")),
            t.has("(" + nc + ") (eleven|twelve|thirteen|fourteen|fifteen|sixteen|seventeen|eighteen|nineteen)") && (t = t.splitAfter("(" + nc + ")"));
            const e = t.match("#Cardinal #Cardinal");
            if (e.found && !t.has("(point|decimal|#Fraction)") && !e.has("#Cardinal (#Multiple|point|decimal)")) {
                const n = t.has(`(one|two|three|four|five|six|seven|eight|nine) (${nc})`)
                  , r = e.has("(" + nc + ") #Cardinal")
                  , o = e.has("#Multiple #Value");
                n || r || o || e.terms().forEach((e => {
                    t = t.splitOn(e)
                }
                ))
            }
            t.match("#Ordinal #Ordinal").match("#TextValue").found && !t.has("#Multiple") && (t.has("(" + nc + ") #Ordinal") || (t = t.splitAfter("#Ordinal"))),
            t = t.splitBefore("#Ordinal [#Cardinal]", 0),
            t.has("#TextValue #NumericValue") && !t.has("(" + nc + "|#Multiple)") && (t = t.splitBefore("#TextValue #NumericValue"))
        }
        return t = t.splitAfter("#NumberRange"),
        t = t.splitBefore("#Year"),
        t
    }
      , oc = function(e) {
        if ("string" == typeof e)
        ...
        const n = e.growRight("#Unit").match("#Unit$").text("machine")
          , r = /[0-9],[0-9]/.test(e.text("text"));
        if (1 === e.terms().length && !e.has("#Multiple")) {
            const o = function(e, t) {
                const n = (e = e.replace(/,/g, "")).split(/([0-9.,]*)/);
                let[r,o] = n
                  , a = n.slice(2).join("");
                return "" !== o && t.length < 2 ? (o = Number(o || e),
                "number" != typeof o && (o = null),
                a = a || "",
                "st" !== a && "nd" !== a && "rd" !== a && "th" !== a || (a = ""),
                {
                    prefix: r || "",
                    num: o,
                    suffix: a
        ...
        o = !1 === o.found ? e.match("^#Fraction$") : o;
        let a = null;
        o.found && (o.has("#Value and #Value #Fraction") && (o = o.match("and #Value #Fraction")),
        a = qu(o),
        t = (e = (e = e.not(o)).not("and$")).text("reduced"));
        let i = 0;
        return t && (i = Lu(t) || 0),
        a && a.decimal && (i += a.decimal),
        {
            hasComma: r,
            prefix: "",
            num: i,
      ...
      , sc = function(e) {
        ...
        return ac.hasOwnProperty(e.prefix) && (t.suffix += " " + ac[e.prefix],
        t.prefix = ""),
        ic.hasOwnProperty(e.suffix) && (t.suffix += " " + ic[e.suffix]),
      ...
      , lc = function(e, t) {
        if ("TextOrdinal" === t) {
            const {prefix: t, suffix: n} = sc(e);
            return t + ec(e) + n
        }
        if ("Ordinal" === t)
            return e.prefix + function(e) {
                const t = e.num;
                if (!t && 0 !== t)
                    return null;
                const n = t % 100;
        ...
        let n = e.num;
        return e.hasComma && (n = n.toLocaleString()),
      ...
      , uc = function(e) {
        ...
        return t = e,
        "[object Array]" === Object.prototype.toString.call(t) ? e.reduce(( (e, t) => (e[t] = !0,
        e)), {}) : e || {};
        var t
    }
      , cc = function(e) {
        class Numbers extends e {
            ...
            parse(e) {
                return this.getNth(e).map(oc)
            }
            get(e) {
                return this.getNth(e).map(oc).map((e => e.num))
            }
            json(e) {
                const t = "object" == typeof e ? e : {};
                return this.getNth(e).map((e => {
            ...
            toNumber() {
                const e = this.map((e => {
                    ...
                    if (null === t.num)
                        return e;
                    const n = e.has("#Ordinal") ? "Ordinal" : "Cardinal"
                      , r = lc(t, n);
                    return e.replaceWith(r, {
                        tags: !0
                    }),
            ...
            toLocaleString() {
                return this.forEach((e => {
                    ...
                    if (e.has("#Ordinal")) {
                        const e = lc(t, "Ordinal").match(/[a-z]+$/);
                        e && (n += e[0] || "")
                    }
                    e.replaceWith(n, {
                        tags: !0
            ...
            toText() {
                const e = this.map((e => {
                    ...
                    if (null === t.num)
                        return e;
                    const n = e.has("#Ordinal") ? "TextOrdinal" : "TextCardinal"
                      , r = lc(t, n);
                    return e.replaceWith(r, {
                        tags: !0
                    }),
            ...
            toCardinal() {
                const e = this.map((e => {
                    ...
                    if (null === t.num)
                        return e;
                    const n = e.has("#TextValue") ? "TextCardinal" : "Cardinal"
                      , r = lc(t, n);
                    return e.replaceWith(r, {
                        tags: !0
                    }),
            ...
            toOrdinal() {
                const e = this.map((e => {
                    ...
                    if (null === t.num)
                        return e;
                    const n = e.has("#TextValue") ? "TextOrdinal" : "Ordinal"
                      , r = lc(t, n);
                    return e.replaceWith(r, {
                        tags: !0
                    }),
            ...
            isEqual(e) {
                return this.filter((t => oc(t).num === e))
            }
            greaterThan(e) {
                return this.filter((t => oc(t).num > e))
            }
            ...
            set(e) {
                ...
                const t = this.map((t => {
                    ...
                    let o = lc(n, r);
                    return n.hasComma && "Cardinal" === r && (o = Number(o).toLocaleString()),
                    (t = t.not("#Currency")).replaceWith(o, {
                        tags: !0
                    }),
                    t
                }
            ...
            update(e) {
                const t = new Numbers(this.document,e);
                return t._cache = this._cache,
                t
            }
        }
        ...
        e.prototype.money = function(e) {
            let t = rc(this);
            return t = t.filter((e => e.has("#Money") || e.after("^#Currency"))),
            t = t.getNth(e),
            new Numbers(this.document,t.pointer)
        }
        ,
    ...
    const dc = {
      ...
      , gc = function(e={}) {
        return !1 !== (e = Object.assign({}, dc, e)).people && this.people().replaceWith("██████████"),
      ...
      , fc = function(e) {
        const t = function(e) {
            let t = e;
            return 1 === t.length ? t : (t = t.if("#Verb"),
            1 === t.length ? t : (t = t.ifNo("(after|although|as|because|before|if|since|than|that|though|when|whenever|where|whereas|wherever|whether|while|why|unless|until|once)"),
            t = t.ifNo("^even (if|though)"),
            t = t.ifNo("^so that"),
            t = t.ifNo("^rather than"),
            t = t.ifNo("^provided that"),
            1 === t.length ? t : (t = t.ifNo("(that|which|whichever|who|whoever|whom|whose|whomever)"),
            1 === t.length ? t : (t = t.ifNo("(^despite|^during|^before|^through|^throughout)"),
            1 === t.length ? t : (t = t.ifNo("^#Gerund"),
            1 === t.length ? t : (0 === t.length && (t = e),
            t.eq(0)))))))
        }(e.clauses())
          , n = t.chunks();
        let r = e.none()
        ...
        return n.forEach(( (e, t) => {
            0 !== t || e.has("<Verb>") ? o.found || !e.has("<Verb>") ? o.found && (a = a.concat(e)) : o = e : r = e
        }
        )),
        o.found && !r.found && (r = o.before("<Noun>+").first()),
        {
            subj: r,
            verb: o,
            pred: a,
        ...
        api: function(e) {
            class Sentences extends e {
                ...
                json(e={}) {
                    return this.map((t => {
                        const n = t.toView().json(e)[0] || {}
                          , {subj: r, verb: o, pred: a, grammar: i} = fc(t);
                        return n.sentence = {
                            subject: r.text("normal"),
                            verb: o.text("normal"),
                            predicate: a.text("normal"),
                            grammar: i
                        },
                        n
                    }
                ...
                toPastTense(e) {
                    return this.getNth(e).map((e => (fc(e),
                    function(e) {
                        let t = e.verbs();
                        const n = t.eq(0);
                        if (n.has("#PastTense"))
                        ...
                        t.length > 1) {
                            ...
                            t = t.if("#PresentTense"),
                            t = t.notIf("#Gerund");
                            const n = e.match("to #Verb+ #Conjunction #Verb").terms();
                            t = t.not(n),
                            t.found && t.verbs().toPastTense()
                        }
                        return e
                    }(e))))
                }
                ...
                toFutureTense(e) {
                    ...
                    e = function(e) {
                        let t = e.verbs();
                        if (t.eq(0).toFutureTense(),
                        t = (e = e.fullSentence()).verbs(),
                        t.length > 1) {
                            t = t.slice(1);
                            const e = t.filter((e => !(e.lookBehind("to$").found || !e.has("#Copula #Gerund") && (e.has("#Gerund") || !e.has("#Copula") && e.has("#PresentTense") && !e.has("#Infinitive") && e.lookBefore("(he|she|it|that|which)$").found))));
                            e.found && e.forEach((e => {
                                if (e.has("#Copula"))
                                    return e.match("was").replaceWith("is"),
                ...
                toNegative(e) {
                    return this.getNth(e).map((e => (fc(e),
                    function(e) {
                        return e.verbs().first().toNegative().compute("chunks"),
                        e
                    }(e))))
                }
                toPositive(e) {
                    return this.getNth(e).map((e => (fc(e),
                    function(e) {
                        return e.verbs().first().toPositive().compute("chunks"),
                        e
                    }(e))))
                }
                isQuestion(e) {
                ...
                isExclamation(e) {
                    const t = this.filter((e => e.lastTerm().has("@hasExclamation")));
                    return t.getNth(e)
                }
                isStatement(e) {
                    const t = this.filter((e => !e.isExclamation().found && !e.isQuestion().found));
                    return t.getNth(e)
                }
                update(e) {
                    const t = new Sentences(this.document,e);
                    return t._cache = this._cache,
                    t
                }
            }
            ...
            const t = {
                sentences: function(e) {
                    ...
                    return t = t.getNth(e),
                    new Sentences(this.document,t.pointer)
                },
                questions: function(e) {
                    const t = function(e) {
                        ...
                        return e.filter((e => {
                            const r = e.docs[0] || []
                              , o = r[r.length - 1];
                            return !(!o || n[o.index[0]].length !== r.length) && (!!t.test(o.post) || function(e) {
                                const t = e.clauses();
    ...
    const vc = function(e) {
        ...
        const n = t.lastName
          , r = t.firstName;
        return r.found && n.found || r.found || n.found || !e.has("^#Honorific .$") || (t.lastName = e.match(".$")),
        t
    }
      , yc = "male"
      , wc = "female"
      ...
      , Pc = function(e, t) {
        ...
        if (!o.has("#Person") && o.has("#Pronoun")) {
            const e = o.match("#Pronoun");
            if (e.has("(they|their)"))
                return null;
            const t = e.has("(he|his)")
        ...
        api: function(e) {
            !function(e) {
                class People extends e {
                    ...
                    update(e) {
                        const t = new People(this.document,e);
                        return t._cache = this._cache,
                        t
                    }
                }
                e.prototype.people = function(e) {
                    let t = function(e) {
                        ...
                        return t = t.splitAfter(n),
                        t
                    }(this);
                    return t = t.getNth(e),
                    new People(this.document,t.pointer)
                }
            }(e),
            function(e) {
                e.prototype.places = function(t) {
                    let n = function(e) {
                        let t = e.match("(#Place|#Address)+")
                          , n = t.match("@hasComma");
                        return n = n.filter((e => !!e.has("(asia|africa|europe|america)$") || !e.has("(#City|#Region|#ProperNoun)$") || !e.after("^(#Country|#Region)").found)),
                        t = t.splitAfter(n),
                        t
                    }(this);
                    return n = n.getNth(t),
    ...
    const Nc = function(e, t) {
        ...
        return 3 === r.length ? {
            pre: r.eq(0).adverbs(),
            post: r.eq(2).adverbs()
        } : r.eq(0).isDoc(t) ? (n.post = r.eq(1).adverbs(),
        n) : (n.pre = r.eq(0).adverbs(),
        n)
    }
      , jc = function(e, t) {
        ...
        if (n.length <= 1)
            return e.none();
        let r = n.eq(0);
        return r = r.not("(#Adverb|#Negative|#Prefix)"),
        r
    }
      , xc = function(e) {
      ...
      , Tc = function(e) {
        ...
        const n = function(e) {
            let t = e;
            return e.wordCount() > 1 && (t = e.not("(#Negative|#Auxiliary|#Modal|#Adverb|#Prefix)")),
      ...
      , Bc = {
        ...
        "want-infinitive": [["^(want|wants|wanted) to #Infinitive$", [Dc]], ["^wanted to #Infinitive$", [Oc]], ["^will want to #Infinitive$", [Ec]]],
        "gerund-phrase": [["^#PastTense #Gerund$", [Oc]], ["^#PresentTense #Gerund$", [Dc]], ["^#Infinitive #Gerund$", [Dc]], ["^will #Infinitive #Gerund$", [Ec]], ["^have #PastTense #Gerund$", [Oc]], ["^will have #PastTense #Gerund$", [Oc]]],
        "simple-present": [["^#PresentTense$", [Dc]], ["^#Infinitive$", [Dc]]],
        "simple-past": [["^#PastTense$", [Oc]]],
        "simple-future": [["^will #Adverb? #Infinitive", [Ec]]],
        "present-progressive": [["^(is|are|am) #Gerund$", [Dc, Gc]]],
        "past-progressive": [["^(was|were) #Gerund$", [Oc, Gc]]],
        "future-progressive": [["^will be #Gerund$", [Ec, Gc]]],
        "present-perfect": [["^(has|have) #PastTense$", [Oc, Fc]]],
        "past-perfect": [["^had #PastTense$", [Oc, Fc]], ["^had #PastTense to #Infinitive", [Oc, Fc]]],
        "future-perfect": [["^will have #PastTense$", [Ec, Fc]]],
        "present-perfect-progressive": [["^(has|have) been #Gerund$", [Oc, Gc]]],
        "past-perfect-progressive": [["^had been #Gerund$", [Oc, Gc]]],
        "future-perfect-progressive": [["^will have been #Gerund$", [Ec, Gc]]],
        "passive-past": [["(got|were|was) #Passive", [Oc, Vc]], ["^(was|were) being #Passive", [Oc, Vc]], ["^(had|have) been #Passive", [Oc, Vc]]],
        "passive-present": [["^(is|are|am) #Passive", [Dc, Vc]], ["^(is|are|am) being #Passive", [Dc, Vc]], ["^has been #Passive", [Dc, Vc]]],
        "passive-future": [["will have been #Passive", [Ec, Vc, Hc]], ["will be being? #Passive", [Ec, Vc, Hc]]],
        "present-conditional": [["would be #PastTense", [Dc, Hc]]],
        "past-conditional": [["would have been #PastTense", [Oc, Hc]]],
        "auxiliary-future": [["(is|are|am|was) going to (#Infinitive|#PresentTense)", [Ec]]],
        "auxiliary-past": [["^did #Infinitive$", [Oc, {
            plural: !1
        }]], ["^used to #Infinitive$", [Oc, Fc]]],
        "auxiliary-present": [["^(does|do) #Infinitive$", [Dc, Fc, {
            plural: !0
        }]]],
        "modal-past": [["^(could|must|should|shall) have #PastTense$", [Oc]]],
        "modal-infinitive": [["^#Modal #Infinitive$", []]],
        infinitive: [["^#Infinitive$", []]]
    }
      , Sc = [];
    Object.keys(Bc).map((e => {
        Bc[e].forEach((t => {
            Sc.push({
                name: e,
                match: t[0],
    ...
    const $c = function(e, t) {
        ...
        for (let t = 0; t < Sc.length; t += 1) {
            const r = Sc[t];
            if (!0 === e.has(r.match)) {
                n.form = r.name,
                Object.assign(n, r.data);
                break
            }
        }
        return n.form || e.has("^#Verb$") && (n.form = "infinitive"),
        n.tense || (n.tense = t.root.has("#PastTense") ? "PastTense" : "PresentTense"),
        n.copula = t.root.has("#Copula"),
        n.isInfinitive = function(e) {
            if (e.has("#Infinitive") && e.growLeft("to").has("^to #Infinitive"))
                return !0;
            return !1
        }(e),
        n
      ...
      , Mc = function(e) {
        if (e.length <= 1)
            return !1;
        return (e.parse()[0] || {}).isSubordinate
    }
      , Lc = function(e, t) {
      ...
      , Kc = function(e) {
        const t = function(e) {
            ...
            t = function(e) {
                let t = e.clauses();
                return t = t.filter(( (e, t) => !(e.has("^(if|unless|while|but|for|per|at|by|that|which|who|from)") || t > 0 && e.has("^#Verb . #Noun+$") || t > 0 && e.has("^#Adverb")))),
                0 === t.length ? e : t
            }(t);
            const n = t.nouns();
            let r = n.last();
            ...
            return a.found || !1 === n.found && (a = t.match("^(that|this|those)"),
            a.found) ? a : (r = n.last(),
            Mc(r) && (n.remove(r),
            r = n.last()),
            Mc(r) && (n.remove(r),
      ...
      , Qc = function(e, t) {
        ...
        return r = n(r, e.model, Rc(e)),
        r && e.replace(t.root, r),
        e
    }
      , Zc = e => e.has("will not") ? e.replace("will not", "have not") : e.remove("will")
      , _c = function(e) {
        if (!e || !e.isView)
            return [];
        return e.json({
      ...
      , Yc = function(e) {
        ...
        return t(e.text("normal"), e.model, Rc(e))
    }
      , eh = {
        tags: !0
    }
      ...
      , nh = {
        noAux: (e, t) => (t.auxiliary.found && (e = e.remove(t.auxiliary)),
        e),
        simple: (e, t) => {
            ...
            a = r(a, e.model, Rc(o));
            return a = n(a, e.model).PastTense,
            a = "been" === a ? "was" : a,
            "was" === a && (a = ( (e, t) => {
                const {subject: n, plural: r} = Kc(e);
        ...
        ,
        both: function(e, t) {
            return t.negative.found ? (e.replace("will", "did"),
            e) : (e = nh.simple(e, t),
            e = nh.noAux(e, t))
        },
        hasHad: e => (e.replace("has", "had", th),
        e),
        hasParticiple: (e, t) => {
            const {conjugate: n, toInfinitive: r} = e.methods.two.transform.verb
              , o = t.root;
            let a = o.text("normal");
            return a = r(a, e.model, Rc(o)),
            n(a, e.model).Participle
        }
    }
      , rh = {
        infinitive: nh.simple,
        "simple-present": nh.simple,
        "simple-past": Jc,
        "simple-future": nh.both,
        "present-progressive": e => (e.replace("are", "were", th),
        e.replace("(is|are|am)", "was", th),
        e),
        "past-progressive": Jc,
        "future-progressive": (e, t) => (e.match(t.root).insertBefore("was"),
        e.remove("(will|be)"),
        e),
        "present-perfect": nh.hasHad,
        "past-perfect": Jc,
        "future-perfect": (e, t) => (e.match(t.root).insertBefore("had"),
        e.has("will") && (e = Zc(e)),
        e.remove("have"),
        e),
        "present-perfect-progressive": nh.hasHad,
        "past-perfect-progressive": Jc,
        "future-perfect-progressive": e => (e.remove("will"),
        e.replace("have", "had", th),
        e),
        "passive-past": e => (e.replace("have", "had", th),
        e),
        "passive-present": e => (e.replace("(is|are)", "was", th),
        e),
        "passive-future": (e, t) => (t.auxiliary.has("will be") && (e.match(t.root).insertBefore("had been"),
        e.remove("(will|be)")),
        t.auxiliary.has("will have been") && (e.replace("have", "had", th),
        e.remove("will")),
        e),
        "present-conditional": e => (e.replace("be", "have been"),
        e),
        "past-conditional": Jc,
        "auxiliary-future": e => (e.replace("(is|are|am)", "was", th),
        e),
        "auxiliary-past": Jc,
        "auxiliary-present": e => (e.replace("(do|does)", "did", th),
        e),
        "modal-infinitive": (e, t) => (e.has("can") ? e.replace("can", "could", th) : (nh.simple(e, t),
        e.match("#Modal").insertAfter("have").tag("Auxiliary")),
        e),
        "modal-past": Jc,
        "want-infinitive": e => (e.replace("(want|wants)", "wanted", th),
        e.remove("will"),
        e),
      ...
      , ah = (e, t) => {
        ...
        i = r(i, e.model, Rc(o));
        const s = n(i, e.model);
        if (i = s.Participle || s.PastTense,
        i) {
            e = e.replace(o, i);
            const t = oh(e);
            e.prepend(t).match(t).tag("Auxiliary"),
            e.remove(a)
        }
        return e
    }
      , ih = {
        infinitive: ah,
        "simple-present": ah,
        "simple-future": (e, t) => e.replace("will", oh(e)),
        "present-perfect": Jc,
        "past-perfect": Jc,
        "future-perfect": (e, t) => e.replace("will have", oh(e)),
        "present-perfect-progressive": Jc,
        "past-perfect-progressive": Jc,
        "future-perfect-progressive": Jc
    }
      , sh = {
        tags: !0
    }
      , lh = (e, t) => {
        ...
        let a = o.text("normal");
        return a = r(a, e.model, Rc(o)),
        !1 === Wc(e) && (a = n(a, e.model).PresentTense),
        o.has("#Copula") && (a = qc(e)),
        a && (e = e.replace(o, a, sh)).not("#Particle").tag("PresentTense"),
        e
    }
      , uh = (e, t) => {
        const {conjugate: n, toInfinitive: r} = e.methods.two.transform.verb
        ...
        let a = o.text("normal");
        return a = r(a, e.model, Rc(o)),
        !1 === Wc(e) && (a = n(a, e.model).Gerund),
        a && (e = e.replace(o, a, sh)).not("#Particle").tag("Gerund"),
        e
    }
      , ch = {
        infinitive: lh,
        "simple-present": (e, t) => {
            ...
            if (!r.has("#Infinitive"))
                return lh(e, t);
            {
                const t = Kc(e).subject;
                if (Wc(e) || t.has("i"))
                    return e;
                const o = r.text("normal")
                  , a = n(o, e.model).PresentTense;
                o !== a && e.replace(r, a, sh)
            }
            return e
        }
        ,
        ...
        ,
        "present-progressive": Jc,
        "past-progressive": (e, t) => {
            const n = qc(e);
            return e.replace("(were|was)", n, sh)
        }
        ,
        "future-progressive": e => (e.match("will").insertBefore("is"),
        e.remove("be"),
        e.remove("will")),
        "present-perfect": (e, t) => (lh(e, t),
        e = e.remove("(have|had|has)")),
        "past-perfect": (e, t) => {
            const n = Kc(e).subject;
            return Wc(e) || n.has("i") ? ((e = Qc(e, t)).remove("had"),
            e) : (e.replace("had", "has", sh),
            e)
        }
        ,
        "future-perfect": e => (e.match("will").insertBefore("has"),
        e.remove("have").remove("will")),
        "present-perfect-progressive": Jc,
        "past-perfect-progressive": e => e.replace("had", "has", sh),
        "future-perfect-progressive": e => (e.match("will").insertBefore("has"),
        e.remove("have").remove("will")),
        "passive-past": (e, t) => {
            const n = qc(e);
            return e.has("(had|have|has)") && e.has("been") ? (e.replace("(had|have|has)", n, sh),
            e.replace("been", "being"),
            e) : e.replace("(got|was|were)", n)
        }
        ,
        "passive-present": Jc,
        "passive-future": e => (e.replace("will", "is"),
        e.replace("be", "being")),
        "present-conditional": Jc,
        "past-conditional": e => (e.replace("been", "be"),
        e.remove("have")),
        "auxiliary-future": (e, t) => (uh(e, t),
        e.remove("(going|to)"),
        e),
        "auxiliary-past": (e, t) => {
            if (t.auxiliary.has("did")) {
                const n = Uc(e);
                return e.replace(t.auxiliary, n),
                e
            }
            return uh(e, t),
            e.replace(t.auxiliary, "is"),
            e
        }
        ,
        "auxiliary-present": Jc,
        "modal-infinitive": Jc,
        "modal-past": (e, t) => (( (e, t) => {
            const {toInfinitive: n} = e.methods.two.transform.verb
              , r = t.root;
        ...
        "want-infinitive": (e, t) => {
            let n = "wants";
            return Wc(e) && (n = "want"),
            e.replace("(want|wanted|wants)", n, sh),
            e.remove("will"),
            e
        }
    }
      ...
      , dh = (e, t) => {
        ...
        if (r.has("#Modal"))
            return e;
        let a = r.text("normal");
        return a = n(a, e.model, Rc(r)),
        a && (e = e.replace(r, a, hh)).not("#Particle").tag("Verb"),
      ...
      , gh = (e, t) => {
        const {conjugate: n, toInfinitive: r} = e.methods.two.transform.verb
          , {root: o, auxiliary: a} = t;
        let i = o.text("normal");
        return i = r(i, e.model, Rc(o)),
        i && (i = n(i, e.model).Gerund,
        e.replace(o, i, hh),
      ...
      , mh = {
        ...
        "simple-past": dh,
        "simple-future": Jc,
        "present-progressive": gh,
        "past-progressive": gh,
        "future-progressive": Jc,
        "present-perfect": e => (e.match("(have|has)").replaceWith("will have"),
        e),
        ...
        "future-perfect-progressive": Jc,
        "passive-past": e => e.has("got") ? e.replace("got", "will get") : e.has("(was|were)") ? (e.replace("(was|were)", "will be"),
        e.remove("being")) : e.has("(have|has|had) been") ? e.replace("(have|has|had) been", "will be") : e,
        "passive-present": e => (e.replace("being", "will be"),
        e.remove("(is|are|am)"),
        e),
        "passive-future": Jc,
        ...
        "auxiliary-future": Jc,
        "auxiliary-past": e => e.has("used") && e.has("to") ? (e.replace("used", "will"),
        e.remove("to")) : (e.replace("did", "will"),
        e),
        ...
        dh(e, t),
        e.remove("(had|have)")),
        "want-infinitive": e => (e.replace("(want|wants|wanted)", "will want"),
        e)
    }
      , ph = {
        tags: !0
      ...
      , bh = function(e, t) {
        const n = Uc(e);
        return e.prepend(n + " not"),
        e
    }
      , vh = function(e) {
        let t = e.match("be");
        return t.found ? (t.prepend("not"),
        e) : (t = e.match("(is|was|am|are|will|were)"),
        t.found ? (t.append("not"),
        e) : e)
    }
      , yh = e => e.has("(is|was|am|are|will|were|be)")
      , wh = {
        "simple-present": (e, t) => !0 === yh(e) ? vh(e) : (e = Qc(e, t),
        e = bh(e)),
        "simple-past": (e, t) => !0 === yh(e) ? vh(e) : ((e = Qc(e, t)).prepend("did not"),
        e),
        imperative: e => (e.prepend("do not"),
        e),
        infinitive: (e, t) => !0 === yh(e) ? vh(e) : bh(e),
        "passive-past": e => {
            if (e.has("got"))
                return e.replace("got", "get", fh),
                e.prepend("did not"),
                e;
            const t = e.match("(was|were|had|have)");
            return t.found && t.append("not"),
            e
        }
        ,
        "auxiliary-past": e => {
            if (e.has("used"))
                return e.prepend("did not"),
                e;
        ...
        ,
        "want-infinitive": (e, t) => e = (e = bh(e)).replace("wants", "want", fh)
    };
    var kh = {
        api: function(e) {
            class Verbs extends e {
                ...
                parse(e) {
                    return this.getNth(e).map(Tc)
                }
                json(e, t) {
                    const n = this.getNth(t).map((t => {
                        const n = t.toView().json(e)[0] || {};
                        return n.verb = function(e) {
                            const t = Tc(e);
                            e = e.clone().toView();
                            const n = $c(e, t);
                            return {
                                root: t.root.text(),
                                preAdverbs: _c(t.adverbs.pre),
                                postAdverbs: _c(t.adverbs.post),
                                auxiliary: Xc(t.auxiliary),
                                negative: t.negative.found,
                                prefix: Xc(t.prefix),
                                infinitive: Yc(t.root),
                                grammar: n
                            }
                        }(t),
                        n
                ...
                subjects(e) {
                    return this.getNth(e).map((e => (Tc(e),
                    Kc(e).subject)))
                }
                adverbs(e) {
                ...
                isSingular(e) {
                    return this.getNth(e).filter((e => !0 !== Kc(e).plural))
                }
                isPlural(e) {
                    return this.getNth(e).filter((e => !0 === Kc(e).plural))
                }
                    ...
                    return this.getNth(e).map((e => {
                        ...
                        return function(e, t) {
                            const {toInfinitive: n} = e.methods.two.transform.verb
                              ...
                              , a = o.terms().harden();
                            let i = r.text("normal");
                            if (i = n(i, e.model, Rc(r)),
                            i && e.replace(r, i, eh).tag("Verb").firstTerm().tag("Infinitive"),
                            a.found && e.remove(a),
                            t.negative.found) {
                            ...
                            return e.fullSentence().compute(["freeze", "lexicon", "preTagger", "postTagger", "unfreeze", "chunks"]),
                            e
                        }(e, t, $c(e, t).form)
                    }
                    ))
                ...
                toPresentTense(e) {
                    return this.getNth(e).map((e => {
                        const t = Tc(e)
                          , n = $c(e, t);
                        return n.isInfinitive ? e : function(e, t, n) {
                            return ch.hasOwnProperty(n) ? ((e = ch[n](e, t)).fullSentence().compute(["tagger", "chunks"]),
                            e) : e
                        }(e, t, n.form)
                    }
                    ))
                ...
                toPastTense(e) {
                    return this.getNth(e).map((e => {
                        const t = Tc(e)
                          , n = $c(e, t);
                        return n.isInfinitive ? e : function(e, t, n) {
                            return rh.hasOwnProperty(n) ? ((e = rh[n](e, t)).fullSentence().compute(["tagger", "chunks"]),
                            e) : e
                        }(e, t, n.form)
                    }
                    ))
                ...
                toFutureTense(e) {
                    return this.getNth(e).map((e => {
                        const t = Tc(e)
                          , n = $c(e, t);
                        return n.isInfinitive ? e : function(e, t, n) {
                            return e.has("will") || e.has("going to") ? e : mh.hasOwnProperty(n) ? ((e = mh[n](e, t)).fullSentence().compute(["tagger", "chunks"]),
                            e) : e
                        }(e, t, n.form)
                    }
                    ))
                ...
                toGerund(e) {
                    return this.getNth(e).map((e => {
                        const t = Tc(e)
                          , n = $c(e, t);
                        return n.isInfinitive ? e : function(e, t) {
                            const {toInfinitive: n, conjugate: r} = e.methods.two.transform.verb
                              , {root: o, auxiliary: a} = t;
                            if (e.has("#Gerund"))
                                return e;
                            let i = o.text("normal");
                            ...
                            return e.replace("not is", "is not"),
                ...
                toPastParticiple(e) {
                    return this.getNth(e).map((e => {
                        const t = Tc(e)
                          , n = $c(e, t);
                        return n.isInfinitive ? e : function(e, t, n) {
                            return ih.hasOwnProperty(n) ? ((e = ih[n](e, t)).fullSentence().compute(["tagger", "chunks"]),
                            e) : ((e = ah(e, t)).fullSentence().compute(["tagger", "chunks"]),
                            e)
                        }(e, t, n.form)
                    }
                    ))
                ...
                conjugate(e) {
                    const {conjugate: t, toInfinitive: n} = this.world.methods.two.transform.verb;
                    return this.getNth(e).map((e => {
                        const r = Tc(e)
                          , o = $c(e, r);
                        "imperative" === o.form && (o.form = "simple-present");
                        let a = r.root.text("normal");
                ...
                toPositive() {
                    const e = this.match("do not #Verb");
                ...
                toNegative(e) {
                    return this.getNth(e).map((e => {
                        ...
                        return function(e, t, n) {
                            if (e.has("#Negative"))
                                return e;
                            if (wh.hasOwnProperty(n))
                                return wh[n](e, t);
                            let r = e.matchOne("be");
                            return r.found ? (r.prepend("not"),
                            e) : !0 === yh(e) ? vh(e) : (r = e.matchOne("(will|had|have|has|did|does|do|#Modal)"),
                            r.found ? (r.append("not"),
                            e) : e)
                        }(e, t, $c(e, t).form)
                    }
                    ))
                ...
                update(e) {
                    const t = new Verbs(this.document,e);
                    return t._cache = this._cache,
                    t
                }
            }
            ...
            e.prototype.verbs = function(e) {
                let t = function(e) {
                    ...
                    t = t.splitBefore("(#PresentTense|#PastTense) [(had|has)]", 0),
                    t = t.not("#Reflexive$"),
                    t = t.not("#Adjective"),
                    ...
                    t = t.if("#Verb"),
                    t.has("(#Verb && !#Auxiliary) #Adverb+? #Copula") && (t = t.splitBefore("#Copula")),
                    t
                }(this);
                return t = t.getNth(e),
                new Verbs(this.document,t.pointer)
            }
        }
    };
    const Ph = function(e, t) {
      ...
      , Ch = function(e, t) {
        ...
        n.found ? n.last() : (n = e.nouns("#Actor"),
        n.found ? n.last() : "f" === t ? Ph("(she|her|hers)", e) : "m" === t ? Ph("(he|him|his)", e) : e.none())
    }
      , Nh = function(e) {
        const t = e.nouns();
        ...
        if (n.found)
            return n.last();
        const r = Ph("(they|their|theirs)", e);
        return r.found ? r : (n = t.match("(somebody|nobody|everybody|anybody|someone|noone|everyone|anyone)"),
        n.found ? n.last() : e.none())
    }
      , jh = function(e, t) {
        let n = e.before()
          , r = t(n);
        return r.found ? r : (n = Ah(e),
        r = t(n),
        r.found ? r : (n = Ah(n),
        r = t(n),
        r.found ? r : e.none()))
    ...
    var xh = {
        compute: {
            coreference: function(e) {
                e.pronouns().if("(he|him|his|she|her|hers|they|their|theirs|it|its)").forEach((e => {
                    let t = null;
                    e.has("(he|him|his)") ? t = jh(e, (e => Ch(e, "m"))) : e.has("(she|her|hers)") ? t = jh(e, (e => Ch(e, "f"))) : e.has("(they|their|theirs)") && (t = jh(e, Nh)),
                    t && t.found && function(e, t) {
        ...
        api: function(e) {
            class Pronouns extends e {
                ...
                hasReference() {
                    return this.compute("coreference"),
                ...
                update(e) {
                    const t = new Pronouns(this.document,e);
                    return t._cache = this._cache,
                    t
                }
            }
            e.prototype.pronouns = function(e) {
                ...
                return t = t.getNth(e),
                new Pronouns(t.document,t.pointer)
            }
        }
    };
    return h.plugin(ql),
